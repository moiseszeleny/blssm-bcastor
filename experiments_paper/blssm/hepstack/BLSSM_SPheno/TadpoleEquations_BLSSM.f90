...
! ------------------------------------------------------------------------------  
! File created at 16:33 on 25.7.2023   
! ----------------------------------------------------------------------  
...
TadpoleValues(1) = Real(((g1**2 + gYB**2 + g2**2)*vd**3 - 8*Bmu*vu + vd*(8._dp*(mHd2) & 
&  - (g1**2 + gYB**2 + g2**2)*vu**2 + 2*(gYB*gBL + g1*gBY)*x1**2 - 2*gYB*gBL*x2**2 - 2*g1*gBY*x2**2 + 8*Mu**2))& 
& /8._dp - Tad1Loop(1),dp) 

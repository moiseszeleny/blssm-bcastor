...
Module Wrapper_OneLoopDecay_Su_BLSSM
Use Model_Data_BLSSM 
Use Kinematics 
Use OneLoopDecay_Su_BLSSM 
Use Control 
Use Settings 
...
Subroutine OneLoopDecay_Su(MSdOS,MSd2OS,MSuOS,MSu2OS,MSeOS,MSe2OS,MSvImOS,            & 
...
Complex(dp),Intent(in) :: cplAhAhhh(4,4,4),cplAhAhSucSuaa(4,4,6,6),cplAhcHpmVWm(4,2),cplAhhhVP(4,4),            & 
...
& cplAhSvImSvIm(4,6,6),cplAhSvImSvRe(4,6,6),cplAhSvReSvRe(4,6,6),cplcChacFuSdL(2,3,6),   & 
& cplcChacFuSdR(2,3,6),cplcChaChaAhL(2,2,4),cplcChaChaAhR(2,2,4),cplcChaChahhL(2,2,4),   & 
...
& cplhhhhSucSuaa(4,4,6,6),cplhhHpmcHpm(4,2,2),cplhhHpmcVWm(4,2),cplhhHpmSucSdaa(4,2,6,6),& 
...
& cplSeSucSecSuaa(6,6,6,6),cplSeSvImcHpm(6,6,2),cplSeSvRecHpm(6,6,2),cplSucSdVGVWmLamct3ct2ct1(6,6)

Complex(dp),Intent(in) :: cplSucSdVPVWmaa(6,6),cplSucSdVWm(6,6),cplSucSdVWmVZaa(6,6),cplSucSdVWmVZpaa(6,6),      & 
...
& cplSucSuVGVZLamct3ct2ct1(6,6),cplSucSuVGVZpLamct3ct2ct1(6,6),cplSucSuVP(6,6),          & 
& cplSucSuVPVPaa(6,6),cplSucSuVPVZaa(6,6),cplSucSuVPVZpaa(6,6),cplSucSuVZ(6,6),          & 
& cplSucSuVZp(6,6),cplSucSuVZpVZpaa(6,6),cplSucSuVZVZaa(6,6),cplSucSuVZVZpaa(6,6),       & 
& cplSuSucSucSuabab(6,6,6,6),cplSuSucSucSuabba(6,6,6,6),cplSuSvImSvImcSuaa(6,6,6,6),     & 
& cplSuSvImSvRecSuaa(6,6,6,6),cplSuSvReSvRecSuaa(6,6,6,6),cplVGVGVG,ctcplAhSucSu(4,6,6), & 
& ctcplcChaFdcSuL(2,3,6),ctcplcChaFdcSuR(2,3,6),ctcplChiFucSuL(7,3,6),ctcplChiFucSuR(7,3,6),& 
& ctcplGluFucSuL(3,6),ctcplGluFucSuR(3,6),ctcplhhSucSu(4,6,6),ctcplSdcHpmcSu(6,2,6),     & 
& ctcplSdcSucVWm(6,6),ctcplSucSuVG(6,6),ctcplSucSuVP(6,6),ctcplSucSuVZ(6,6),             & 
& ctcplSucSuVZp(6,6),GcplcHpmVPVWm(2),GcplHpmcVWmVP(2),GcplSdcHpmcSu(6,2,6),             & 
& GosZcplcHpmVPVWm(2),GosZcplHpmcVWmVP(2),GosZcplSdcHpmcSu(6,2,6),GZcplcHpmVPVWm(2),     & 
& GZcplHpmcVWmVP(2),GZcplSdcHpmcSu(6,2,6),ZcplAhSucSu(4,6,6),ZcplcChaFdcSuL(2,3,6),      & 
& ZcplcChaFdcSuR(2,3,6),ZcplChiFucSuL(7,3,6),ZcplChiFucSuR(7,3,6),ZcplGluFucSuL(3,6),    & 
& ZcplGluFucSuR(3,6),ZcplhhSucSu(4,6,6),ZcplSdcHpmcSu(6,2,6),ZcplSdcSucVWm(6,6),         & 
& ZcplSucSuVZ(6,6),ZcplSucSuVZp(6,6)
...
Real(dp) :: MRPSuToSuAh(6,6,4),MRGSuToSuAh(6,6,4), MRPZSuToSuAh(6,6,4),MRGZSuToSuAh(6,6,4) 
Real(dp) :: MVPSuToSuAh(6,6,4) 
Real(dp) :: RMsqTreeSuToSuAh(6,6,4),RMsqWaveSuToSuAh(6,6,4),RMsqVertexSuToSuAh(6,6,4) 
Complex(dp) :: AmpTreeSuToSuAh(6,6,4),AmpWaveSuToSuAh(6,6,4)=(0._dp,0._dp),AmpVertexSuToSuAh(6,6,4)& 
 & ,AmpVertexIRosSuToSuAh(6,6,4),AmpVertexIRdrSuToSuAh(6,6,4), AmpSumSuToSuAh(6,6,4), AmpSum2SuToSuAh(6,6,4) 
Complex(dp) :: AmpTreeZSuToSuAh(6,6,4),AmpWaveZSuToSuAh(6,6,4),AmpVertexZSuToSuAh(6,6,4) 
Real(dp) :: AmpSqSuToSuAh(6,6,4),  AmpSqTreeSuToSuAh(6,6,4) 
...
Real(dp) :: MRPSuToSuhh(6,6,4),MRGSuToSuhh(6,6,4), MRPZSuToSuhh(6,6,4),MRGZSuToSuhh(6,6,4) 
Real(dp) :: MVPSuToSuhh(6,6,4) 
Real(dp) :: RMsqTreeSuToSuhh(6,6,4),RMsqWaveSuToSuhh(6,6,4),RMsqVertexSuToSuhh(6,6,4) 
Complex(dp) :: AmpTreeSuToSuhh(6,6,4),AmpWaveSuToSuhh(6,6,4)=(0._dp,0._dp),AmpVertexSuToSuhh(6,6,4)& 
 & ,AmpVertexIRosSuToSuhh(6,6,4),AmpVertexIRdrSuToSuhh(6,6,4), AmpSumSuToSuhh(6,6,4), AmpSum2SuToSuhh(6,6,4) 
Complex(dp) :: AmpTreeZSuToSuhh(6,6,4),AmpWaveZSuToSuhh(6,6,4),AmpVertexZSuToSuhh(6,6,4) 
Real(dp) :: AmpSqSuToSuhh(6,6,4),  AmpSqTreeSuToSuhh(6,6,4) 
...
Call Amplitude_Tree_BLSSM_SuToSuAh(cplAhSucSu,MAh,MSu,MAh2,MSu2,AmpTreeSuToSuAh)

  Else 
Call Amplitude_Tree_BLSSM_SuToSuAh(ZcplAhSucSu,MAh,MSu,MAh2,MSu2,AmpTreeSuToSuAh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_BLSSM_SuToSuAh(MLambda,em,gs,cplAhSucSu,MAhOS,MSuOS,MRPSuToSuAh,      & 
& MRGSuToSuAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_BLSSM_SuToSuAh(MLambda,em,gs,ZcplAhSucSu,MAhOS,MSuOS,MRPSuToSuAh,     & 
& MRGSuToSuAh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_BLSSM_SuToSuAh(MLambda,em,gs,cplAhSucSu,MAh,MSu,MRPSuToSuAh,          & 
& MRGSuToSuAh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_BLSSM_SuToSuAh(MLambda,em,gs,ZcplAhSucSu,MAh,MSu,MRPSuToSuAh,         & 
& MRGSuToSuAh)
...
Call Amplitude_WAVE_BLSSM_SuToSuAh(cplAhSucSu,ctcplAhSucSu,MAh,MAh2,MSu,              & 
& MSu2,ZfAh,ZfSu,AmpWaveSuToSuAh)



!Vertex Corrections 
Call Amplitude_VERTEX_BLSSM_SuToSuAh(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,MHpm,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_BLSSM_SuToSuAh(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,               & 
...
& cplAhHpmSucSdaa,cplAhSdcHpmcSuaa,cplHpmSucHpmcSuaa,cplSdSucSdcSuabba,cplSdSucSdcSuabab,& 
& cplSeSucSecSuaa,cplSuSucSucSuabba,cplSuSucSucSuabab,cplSuSvImSvImcSuaa,cplSuSvImSvRecSuaa,& 
& cplSuSvReSvRecSuaa,AmpVertexIRdrSuToSuAh)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_BLSSM_SuToSuAh(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,              & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_BLSSM_SuToFuChi(cplChiFucSuL,cplChiFucSuR,MChi,MFu,               & 
& MSu,MChi2,MFu2,MSu2,AmpTreeSuToFuChi)

  Else 
Call Amplitude_Tree_BLSSM_SuToFuChi(ZcplChiFucSuL,ZcplChiFucSuR,MChi,MFu,             & 
& MSu,MChi2,MFu2,MSu2,AmpTreeSuToFuChi)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_BLSSM_SuToFuChi(MLambda,em,gs,cplChiFucSuL,cplChiFucSuR,              & 
& MChiOS,MFuOS,MSuOS,MRPSuToFuChi,MRGSuToFuChi)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_BLSSM_SuToFuChi(MLambda,em,gs,ZcplChiFucSuL,ZcplChiFucSuR,            & 
& MChiOS,MFuOS,MSuOS,MRPSuToFuChi,MRGSuToFuChi)
...
!Self-energy Corrections 
Call Amplitude_WAVE_BLSSM_SuToFuChi(cplChiFucSuL,cplChiFucSuR,ctcplChiFucSuL,         & 
& ctcplChiFucSuR,MChi,MChi2,MFu,MFu2,MSu,MSu2,ZfFUL,ZfFUR,ZfL0,ZfSu,AmpWaveSuToFuChi)



!Vertex Corrections 
Call Amplitude_VERTEX_BLSSM_SuToFuChi(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,MHpm,            & 
...
& cplSdcSucVWm,cplSucSuVG,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,AmpVertexSuToFuChi)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_BLSSM_SuToFuChi(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,              & 
...
& cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,             & 
& cplcFuFuVZL,cplcFuFuVZR,cplcFuFuVZpL,cplcFuFuVZpR,cplhhSucSu,cplSdcHpmcSu,             & 
& cplSdcSucVWm,cplSucSuVG,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,AmpVertexIRdrSuToFuChi)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_BLSSM_SuToFuChi(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,             & 
...
& cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,             & 
& cplcFuFuVZL,cplcFuFuVZR,cplcFuFuVZpL,cplcFuFuVZpR,cplhhSucSu,cplSdcHpmcSu,             & 
& cplSdcSucVWm,cplSucSuVG,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,AmpVertexIRosSuToFuChi)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_BLSSM_SuTocChaFd(cplcChaFdcSuL,cplcChaFdcSuR,MCha,MFd,            & 
& MSu,MCha2,MFd2,MSu2,AmpTreeSuTocChaFd)

  Else 
Call Amplitude_Tree_BLSSM_SuTocChaFd(ZcplcChaFdcSuL,ZcplcChaFdcSuR,MCha,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_BLSSM_SuTocChaFd(MLambda,em,gs,cplcChaFdcSuL,cplcChaFdcSuR,           & 
& MChaOS,MFdOS,MSuOS,MRPSuTocChaFd,MRGSuTocChaFd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_BLSSM_SuTocChaFd(MLambda,em,gs,ZcplcChaFdcSuL,ZcplcChaFdcSuR,         & 
& MChaOS,MFdOS,MSuOS,MRPSuTocChaFd,MRGSuTocChaFd)
...
!Self-energy Corrections 
Call Amplitude_WAVE_BLSSM_SuTocChaFd(cplcChaFdcSuL,cplcChaFdcSuR,ctcplcChaFdcSuL,     & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_BLSSM_SuTocChaFd(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,MHpm,           & 
& MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,MHpm2,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_BLSSM_SuTocChaFd(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,             & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
...
& cplcChaFdcSuL,cplcChaFdcSuR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdcVWmL,cplcFuFdcVWmR,   & 
& cplGluFucSuL,cplGluFucSuR,cplhhSucSu,cplcChacFuSdL,cplcChacFuSdR,cplSdcHpmcSu,         & 
& cplSdcSucVWm,cplSucSuVG,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,AmpVertexIRdrSuTocChaFd)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_BLSSM_SuTocChaFd(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,            & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
...
& cplSucSuVG,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,AmpVertexIRosSuTocChaFd)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_BLSSM_SuToGluFu(cplGluFucSuL,cplGluFucSuR,MFu,MGlu,               & 
& MSu,MFu2,MGlu2,MSu2,AmpTreeSuToGluFu)

  Else 
Call Amplitude_Tree_BLSSM_SuToGluFu(ZcplGluFucSuL,ZcplGluFucSuR,MFu,MGlu,             & 
& MSu,MFu2,MGlu2,MSu2,AmpTreeSuToGluFu)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_BLSSM_SuToGluFu(MLambda,em,gs,cplGluFucSuL,cplGluFucSuR,              & 
& MFuOS,MGluOS,MSuOS,MRPSuToGluFu,MRGSuToGluFu)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_BLSSM_SuToGluFu(MLambda,em,gs,ZcplGluFucSuL,ZcplGluFucSuR,            & 
& MFuOS,MGluOS,MSuOS,MRPSuToGluFu,MRGSuToGluFu)
...
!Self-energy Corrections 
Call Amplitude_WAVE_BLSSM_SuToGluFu(cplGluFucSuL,cplGluFucSuR,ctcplGluFucSuL,         & 
& ctcplGluFucSuR,MFu,MFu2,MGlu,MGlu2,MSu,MSu2,ZffG,ZfFUL,ZfFUR,ZfSu,AmpWaveSuToGluFu)



!Vertex Corrections 
Call Amplitude_VERTEX_BLSSM_SuToGluFu(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,MHpm,            & 
& MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,MHpm2,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_BLSSM_SuToGluFu(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,              & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
...
& cplGluGluVGL,cplGluGluVGR,cplcFdGluSdL,cplcFdGluSdR,cplcFuGluSuL,cplcFuGluSuR,         & 
& cplhhSucSu,cplSdcHpmcSu,cplSdcSucVWm,cplSucSuVG,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,     & 
& AmpVertexIRdrSuToGluFu)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_BLSSM_SuToGluFu(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,             & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_BLSSM_SuToSuhh(cplhhSucSu,Mhh,MSu,Mhh2,MSu2,AmpTreeSuToSuhh)

  Else 
Call Amplitude_Tree_BLSSM_SuToSuhh(ZcplhhSucSu,Mhh,MSu,Mhh2,MSu2,AmpTreeSuToSuhh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_BLSSM_SuToSuhh(MLambda,em,gs,cplhhSucSu,MhhOS,MSuOS,MRPSuToSuhh,      & 
& MRGSuToSuhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_BLSSM_SuToSuhh(MLambda,em,gs,ZcplhhSucSu,MhhOS,MSuOS,MRPSuToSuhh,     & 
& MRGSuToSuhh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_BLSSM_SuToSuhh(MLambda,em,gs,cplhhSucSu,Mhh,MSu,MRPSuToSuhh,          & 
& MRGSuToSuhh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_BLSSM_SuToSuhh(MLambda,em,gs,ZcplhhSucSu,Mhh,MSu,MRPSuToSuhh,         & 
& MRGSuToSuhh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_BLSSM_SuToSuhh(cplhhSucSu,ctcplhhSucSu,Mhh,Mhh2,MSu,              & 
& MSu2,Zfhh,ZfSu,AmpWaveSuToSuhh)



!Vertex Corrections 
Call Amplitude_VERTEX_BLSSM_SuToSuhh(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,MHpm,             & 
& MSd,MSe,MSu,MSvIm,MSvRe,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,              & 
& MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,              & 
...
& cplSucSuVZVZpaa,cplSucSuVZpVZpaa,AmpVertexSuToSuhh)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_BLSSM_SuToSuhh(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,               & 
& MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
& MFu2,MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVG2,MVP2,MVWm2,MVZ2,               & 
...
& cplSucSuVZVZaa,cplSucSuVZVZpaa,cplSucSuVZpVZpaa,AmpVertexIRdrSuToSuhh)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_BLSSM_SuToSuhh(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,              & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVG,MVP,MVWmOS,MVZOS,            & 
& MVZpOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,             & 
& MSe2OS,MSu2OS,MSvIm2OS,MSvRe2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,MVZp2OS,cplAhAhhh,            & 
...
& cplSeSucSecSuaa,cplSuSucSucSuabba,cplSuSucSucSuabab,cplSuSvImSvImcSuaa,cplSuSvImSvRecSuaa,& 
& cplSuSvReSvRecSuaa,cplSucSuVPVZaa,cplSucSuVPVZpaa,cplSucSucVWmVWmaa,cplSucSuVZVZaa,    & 
& cplSucSuVZVZpaa,cplSucSuVZpVZpaa,AmpVertexIRosSuToSuhh)
...
& cplSdSucSdcSuabab,cplSeSucSecSuaa,cplSuSucSucSuabba,cplSuSucSucSuabab,cplSuSvImSvImcSuaa,& 
& cplSuSvImSvRecSuaa,cplSuSvReSvRecSuaa,cplSucSuVPVZaa,cplSucSuVPVZpaa,cplSucSucVWmVWmaa,& 
& cplSucSuVZVZaa,cplSucSuVZVZpaa,cplSucSuVZpVZpaa,AmpVertexIRosSuToSuhh)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_BLSSM_SuTocHpmSd(cplSdcHpmcSu,MHpm,MSd,MSu,MHpm2,MSd2,            & 
& MSu2,AmpTreeSuTocHpmSd)

  Else 
Call Amplitude_Tree_BLSSM_SuTocHpmSd(ZcplSdcHpmcSu,MHpm,MSd,MSu,MHpm2,MSd2,           & 
& MSu2,AmpTreeSuTocHpmSd)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_BLSSM_SuTocHpmSd(MLambda,em,gs,cplSdcHpmcSu,MHpmOS,MSdOS,             & 
& MSuOS,MRPSuTocHpmSd,MRGSuTocHpmSd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_BLSSM_SuTocHpmSd(MLambda,em,gs,ZcplSdcHpmcSu,MHpmOS,MSdOS,            & 
& MSuOS,MRPSuTocHpmSd,MRGSuTocHpmSd)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_BLSSM_SuTocHpmSd(MLambda,em,gs,cplSdcHpmcSu,MHpm,MSd,MSu,             & 
& MRPSuTocHpmSd,MRGSuTocHpmSd)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_BLSSM_SuTocHpmSd(MLambda,em,gs,ZcplSdcHpmcSu,MHpm,MSd,MSu,            & 
& MRPSuTocHpmSd,MRGSuTocHpmSd)
...
!Self-energy Corrections 
Call Amplitude_WAVE_BLSSM_SuTocHpmSd(cplSdcHpmcSu,ctcplSdcHpmcSu,MHpm,MHpm2,          & 
& MSd,MSd2,MSu,MSu2,ZfHpm,ZfSd,ZfSu,AmpWaveSuTocHpmSd)



!Vertex Corrections 
Call Amplitude_VERTEX_BLSSM_SuTocHpmSd(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,MHpm,           & 
& MSd,MSe,MSu,MSvIm,MSvRe,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,              & 
& MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,              & 
...
& cplSdcSucVWmVZpaa,AmpVertexSuTocHpmSd)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_BLSSM_SuTocHpmSd(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,             & 
& MHpm,MSd,MSe,MSu,MSvIm,MSvRe,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
& MFu2,MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSvIm2,MSvRe2,MVG2,MVP2,MVWm2,MVZ2,               & 
...
& cplAhSdcHpmcSuaa,cplhhSdcHpmcSuaa,cplHpmSdcHpmcSdaa,cplHpmSucHpmcSuaa,cplSdSucSdcSuabba,& 
& cplSdSucSdcSuabab,cplSdSvImcSecSuaa,cplSdSvRecSecSuaa,cplSdcSucVWmVPaa,cplSdcSucVWmVZaa,& 
& cplSdcSucVWmVZpaa,AmpVertexIRdrSuTocHpmSd)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_BLSSM_SuTocHpmSd(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,            & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvImOS,MSvReOS,MVG,MVP,MVWmOS,MVZOS,            & 
& MVZpOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_BLSSM_SuToSdcVWm(cplSdcSucVWm,MSd,MSu,MVWm,MSd2,MSu2,             & 
& MVWm2,AmpTreeSuToSdcVWm)

  Else 
Call Amplitude_Tree_BLSSM_SuToSdcVWm(ZcplSdcSucVWm,MSd,MSu,MVWm,MSd2,MSu2,            & 
& MVWm2,AmpTreeSuToSdcVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_BLSSM_SuToSdcVWm(MLambda,em,gs,cplSdcSucVWm,MSdOS,MSuOS,              & 
& MVWmOS,MRPSuToSdcVWm,MRGSuToSdcVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_BLSSM_SuToSdcVWm(MLambda,em,gs,ZcplSdcSucVWm,MSdOS,MSuOS,             & 
& MVWmOS,MRPSuToSdcVWm,MRGSuToSdcVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_BLSSM_SuToSdcVWm(MLambda,em,gs,cplSdcSucVWm,MSd,MSu,MVWm,             & 
& MRPSuToSdcVWm,MRGSuToSdcVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_BLSSM_SuToSdcVWm(MLambda,em,gs,ZcplSdcSucVWm,MSd,MSu,MVWm,            & 
& MRPSuToSdcVWm,MRGSuToSdcVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_BLSSM_SuToSdcVWm(cplSdcSucVWm,ctcplSdcSucVWm,MSd,MSd2,            & 
& MSu,MSu2,MVWm,MVWm2,ZfSd,ZfSu,ZfVWm,AmpWaveSuToSdcVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_BLSSM_SuToSdcVWm(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,MHpm,           & 
& MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,MHpm2,             & 
& MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhHpmcVWm,cplAhSdcSd,cplAhSucSu,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_BLSSM_SuToSdcVWm(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,             & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
...
& cplSdcSucVWmVZpaa,cplSucSucVWmVWmaa,AmpVertexIRdrSuToSdcVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_BLSSM_SuToSdcVWm(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,            & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
& MVZ2OS,MVZp2OS,cplAhHpmcVWm,cplAhSdcSd,cplAhSucSu,cplChiChacVWmL,cplChiChacVWmR,       & 
& cplChiFucSuL,cplChiFucSuR,cplcFdChiSdL,cplcFdChiSdR,cplcChaFdcSuL,cplcChaFdcSuR,       & 
...
& cplHpmcVWmVZp,cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,cplcChacFuSdL,              & 
& cplcChacFuSdR,GosZcplSdcHpmcSu,ZcplSdcSucVWm,cplSucSuVG,cplSucSuVP,cplSucSuVZ,         & 
& cplSucSuVZp,cplcVWmVPVWm,cplcVWmVWmVZ,cplcVWmVWmVZp,cplSdcSucVWmVGLamct4ct2ct1,        & 
...
& cplcChaFdcSuL,cplcChaFdcSuR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplGluFucSuL,cplGluFucSuR,     & 
& cplcFdGluSdL,cplcFdGluSdR,cplhhHpmcVWm,cplhhSdcSd,cplhhSucSu,cplhhcVWmVWm,             & 
& GZcplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,            & 
& cplSdcSdVZp,cplcChacFuSdL,cplcChacFuSdR,GZcplSdcHpmcSu,ZcplSdcSucVWm,cplSucSuVG,       & 
& cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplcVWmVPVWm,cplcVWmVWmVZ,cplcVWmVWmVZp,             & 
& cplSdcSucVWmVGLamct4ct2ct1,cplSdcSucVWmVPaa,cplSdcSdcVWmVWmaa,cplSdcSucVWmVZaa,        & 
...
& cplHpmcVWmVZp,cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,cplcChacFuSdL,              & 
& cplcChacFuSdR,GcplSdcHpmcSu,cplSdcSucVWm,cplSucSuVG,cplSucSuVP,cplSucSuVZ,             & 
& cplSucSuVZp,cplcVWmVPVWm,cplcVWmVWmVZ,cplcVWmVWmVZp,cplSdcSucVWmVGLamct4ct2ct1,        & 
& cplSdcSucVWmVPaa,cplSdcSdcVWmVWmaa,cplSdcSucVWmVZaa,cplSdcSucVWmVZpaa,cplSucSucVWmVWmaa,& 
& AmpVertexIRosSuToSdcVWm)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_BLSSM_SuToSuVZ(cplSucSuVZ,MSu,MVZ,MSu2,MVZ2,AmpTreeSuToSuVZ)

  Else 
Call Amplitude_Tree_BLSSM_SuToSuVZ(ZcplSucSuVZ,MSu,MVZ,MSu2,MVZ2,AmpTreeSuToSuVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_BLSSM_SuToSuVZ(MLambda,em,gs,cplSucSuVZ,MSuOS,MVZOS,MRPSuToSuVZ,      & 
& MRGSuToSuVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_BLSSM_SuToSuVZ(MLambda,em,gs,ZcplSucSuVZ,MSuOS,MVZOS,MRPSuToSuVZ,     & 
& MRGSuToSuVZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_BLSSM_SuToSuVZ(MLambda,em,gs,cplSucSuVZ,MSu,MVZ,MRPSuToSuVZ,          & 
& MRGSuToSuVZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_BLSSM_SuToSuVZ(MLambda,em,gs,ZcplSucSuVZ,MSu,MVZ,MRPSuToSuVZ,         & 
& MRGSuToSuVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_BLSSM_SuToSuVZ(cplSucSuVP,cplSucSuVZ,cplSucSuVZp,ctcplSucSuVP,    & 
& ctcplSucSuVZ,ctcplSucSuVZp,MSu,MSu2,MVP,MVP2,MVZ,MVZ2,ZfSu,ZfVPVZ,ZfVZ,ZfVZpVZ,        & 
& AmpWaveSuToSuVZ)



!Vertex Corrections 
Call Amplitude_VERTEX_BLSSM_SuToSuVZ(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,MHpm,             & 
& MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,MHpm2,             & 
& MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhhhVZ,cplAhSucSu,cplcFdChaSuL,cplcFdChaSuR,   & 
...
& cplhhSucSu,cplhhVPVZ,cplhhVZVZ,cplhhVZVZp,cplHpmSucSd,cplHpmcHpmVZ,cplHpmcVWmVZ,       & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_BLSSM_SuToSuVZ(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,               & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
...
& cplcFuGluSuR,cplhhSucSu,cplhhVPVZ,cplhhVZVZ,cplhhVZVZp,cplHpmSucSd,cplHpmcHpmVZ,       & 
& cplHpmcVWmVZ,cplSdcSdVZ,cplSdcHpmcSu,cplSdcSucVWm,cplSucSuVG,cplSucSuVP,               & 
& cplSucSdVWm,cplSucSuVZ,cplSucSuVZp,cplcHpmVWmVZ,cplcVWmVWmVZ,cplSdcSucVWmVZaa,         & 
& cplSucSuVGVZLamct3ct2ct1,cplSucSuVPVZaa,cplSucSdVWmVZaa,cplSucSuVZVZaa,cplSucSuVZVZpaa,& 
& AmpVertexIRdrSuToSuVZ)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_BLSSM_SuToSuVZ(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,              & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
...
& cplhhVPVZ,cplhhVZVZ,cplhhVZVZp,cplHpmSucSd,cplHpmcHpmVZ,cplHpmcVWmVZ,cplSdcSdVZ,       & 
...
& cplcFuGluSuR,cplhhSucSu,cplhhVPVZ,cplhhVZVZ,cplhhVZVZp,cplHpmSucSd,cplHpmcHpmVZ,       & 
& cplHpmcVWmVZ,cplSdcSdVZ,cplSdcHpmcSu,cplSdcSucVWm,cplSucSuVG,cplSucSuVP,               & 
& cplSucSdVWm,ZcplSucSuVZ,cplSucSuVZp,cplcHpmVWmVZ,cplcVWmVWmVZ,cplSdcSucVWmVZaa,        & 
& cplSucSuVGVZLamct3ct2ct1,cplSucSuVPVZaa,cplSucSdVWmVZaa,cplSucSuVZVZaa,cplSucSuVZVZpaa,& 
& AmpVertexIRosSuToSuVZ)
...
& cplSucSdVWmVZaa,cplSucSuVZVZaa,cplSucSuVZVZpaa,AmpVertexIRosSuToSuVZ)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_BLSSM_SuToSuVZp(cplSucSuVZp,MSu,MVZp,MSu2,MVZp2,AmpTreeSuToSuVZp)

  Else 
Call Amplitude_Tree_BLSSM_SuToSuVZp(ZcplSucSuVZp,MSu,MVZp,MSu2,MVZp2,AmpTreeSuToSuVZp)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_BLSSM_SuToSuVZp(MLambda,em,gs,cplSucSuVZp,MSuOS,MVZpOS,               & 
& MRPSuToSuVZp,MRGSuToSuVZp)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_BLSSM_SuToSuVZp(MLambda,em,gs,ZcplSucSuVZp,MSuOS,MVZpOS,              & 
& MRPSuToSuVZp,MRGSuToSuVZp)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_BLSSM_SuToSuVZp(MLambda,em,gs,cplSucSuVZp,MSu,MVZp,MRPSuToSuVZp,      & 
& MRGSuToSuVZp)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_BLSSM_SuToSuVZp(MLambda,em,gs,ZcplSucSuVZp,MSu,MVZp,MRPSuToSuVZp,     & 
& MRGSuToSuVZp)
...
!Self-energy Corrections 
Call Amplitude_WAVE_BLSSM_SuToSuVZp(cplSucSuVP,cplSucSuVZ,cplSucSuVZp,ctcplSucSuVP,   & 
& ctcplSucSuVZ,ctcplSucSuVZp,MSu,MSu2,MVP,MVP2,MVZp,MVZp2,ZfSu,ZfVPVZp,ZfVZp,            & 
& ZfVZVZp,AmpWaveSuToSuVZp)



!Vertex Corrections 
Call Amplitude_VERTEX_BLSSM_SuToSuVZp(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,MHpm,            & 
& MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,MHpm2,             & 
& MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhhhVZp,cplAhSucSu,cplcFdChaSuL,               & 
...
& cplcFuGluSuR,cplhhSucSu,cplhhVPVZp,cplhhVZVZp,cplhhVZpVZp,cplHpmSucSd,cplHpmcHpmVZp,   & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_BLSSM_SuToSuVZp(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,              & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
...
& cplSucSuVZpVZpaa,AmpVertexIRdrSuToSuVZp)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_BLSSM_SuToSuVZp(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,             & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_BLSSM_SuToSuVG(cplSucSuVG,ctcplSucSuVG,MSuOS,MSu2OS,              & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_BLSSM_SuToSuVG(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,MGluOS,          & 
...
& MVZp2OS,cplAhSucSu,cplcFdChaSuL,cplcFdChaSuR,cplChiFucSuL,cplChiFucSuR,cplcFuChiSuL,   & 
...
& cplSucSuVG,cplSucSuVP,cplSucSdVWm,cplSucSuVZ,cplSucSuVZp,cplVGVGVG,cplSdcSucVWmVGLamct4ct2ct1,& 
...
!Self-energy Corrections 
Call Amplitude_WAVE_BLSSM_SuToSuVG(cplSucSuVG,ctcplSucSuVG,MSu,MSu2,MVG,              & 
& MVG2,ZfSu,ZfVG,AmpWaveSuToSuVG)



!Vertex Corrections 
Call Amplitude_VERTEX_BLSSM_SuToSuVG(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,MHpm,             & 
& MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,MHpm2,             & 
& MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhSucSu,cplcFdChaSuL,cplcFdChaSuR,             & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_BLSSM_SuToSuVP(cplSucSuVP,cplSucSuVZ,cplSucSuVZp,ctcplSucSuVP,    & 
& ctcplSucSuVZ,ctcplSucSuVZp,MSuOS,MSu2OS,MVP,MVP2,ZfSu,ZfVP,ZfVZpVP,ZfVZVP,             & 
& AmpWaveSuToSuVP)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_BLSSM_SuToSuVP(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,MGluOS,          & 
& MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,MCha2OS,MChi2OS,           & 
& MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,           & 
& MVZp2OS,cplAhhhVP,cplAhSucSu,cplcFdChaSuL,cplcFdChaSuR,cplcChaChaVPL,cplcChaChaVPR,    & 
& cplChiChiVPL,cplChiChiVPR,cplChiFucSuL,cplChiFucSuR,cplcFuChiSuL,cplcFuChiSuR,         & 
& cplcFdFdVPL,cplcFdFdVPR,cplcChaFdcSuL,cplcChaFdcSuR,cplGluFucSuL,cplGluFucSuR,         & 
& cplcFuFuVPL,cplcFuFuVPR,cplcFuGluSuL,cplcFuGluSuR,cplhhSucSu,cplhhVPVZ,cplhhVPVZp,     & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_BLSSM_SuToSuVP(cplSucSuVP,cplSucSuVZ,cplSucSuVZp,ctcplSucSuVP,    & 
& ctcplSucSuVZ,ctcplSucSuVZp,MSu,MSu2,MVP,MVP2,ZfSu,ZfVP,ZfVZpVP,ZfVZVP,AmpWaveSuToSuVP)



!Vertex Corrections 
Call Amplitude_VERTEX_BLSSM_SuToSuVP(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,MHpm,             & 
& MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,MHpm2,             & 
& MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhhhVP,cplAhSucSu,cplcFdChaSuL,cplcFdChaSuR,   & 
& cplcChaChaVPL,cplcChaChaVPR,cplChiChiVPL,cplChiChiVPR,cplChiFucSuL,cplChiFucSuR,       & 
...
& cplhhSucSu,cplhhVPVZ,cplhhVPVZp,cplHpmSucSd,cplHpmcHpmVP,cplHpmcVWmVP,cplSdcSdVP,      & 
& cplSdcHpmcSu,cplSdcSucVWm,cplSucSuVG,cplSucSuVP,cplSucSdVWm,cplSucSuVZ,cplSucSuVZp,    & 
& cplcHpmVPVWm,cplcVWmVPVWm,cplSdcSucVWmVPaa,cplSucSuVGVPLamct3ct2ct1,cplSucSuVPVPaa,    & 
& cplSucSdVPVWmaa,cplSucSuVPVZaa,cplSucSuVPVZpaa,AmpVertexSuToSuVP)
...
End Module Wrapper_OneLoopDecay_Su_BLSSM

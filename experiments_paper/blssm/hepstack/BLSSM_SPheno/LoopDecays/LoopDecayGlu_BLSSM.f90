...
! ------------------------------------------------------------------------------  
! File created at 16:25 on 25.7.2023   
! ----------------------------------------------------------------------  
 
 
Module OneLoopDecay_Glu_BLSSM
Use Control 
Use Settings 
Use LoopFunctions 
...
Subroutine Amplitude_Tree_BLSSM_GluToFdcSd(cplGluFdcSdL,cplGluFdcSdR,MFd,             & 
...
Amp(:,gt2, gt3) = AmpC 
    End Do
  End Do
End Subroutine Amplitude_Tree_BLSSM_GluToFdcSd


Subroutine Gamma_Real_BLSSM_GluToFdcSd(MLambda,em,gs,cplGluFdcSdL,cplGluFdcSdR,       & 
...
End if 
    End Do
  End Do
End Subroutine Gamma_Real_BLSSM_GluToFdcSd


Subroutine Amplitude_WAVE_BLSSM_GluToFdcSd(cplGluFdcSdL,cplGluFdcSdR,ctcplGluFdcSdL,  & 
...
Amp(:,gt2, gt3) = AmpC 
    End Do
  End Do
End Subroutine Amplitude_WAVE_BLSSM_GluToFdcSd


Subroutine Amplitude_VERTEX_BLSSM_GluToFdcSd(MAh,MCha,MChi,MFd,MFu,MGlu,              & 
...
Amp(:,gt2, gt3) = Amp(:,gt2, gt3) + oo16pi2*(-3._dp/2._dp*(0.,1._dp))*AmpC 
    ...
    End Do
  End Do
End Subroutine Amplitude_VERTEX_BLSSM_GluToFdcSd


Subroutine Amplitude_IR_VERTEX_BLSSM_GluToFdcSd(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplcFdFdAhL,cplcFdFdAhR,               & 
& cplAhSdcSd,cplChaFucSdL,cplChaFucSdR,cplChiFdcSdL,cplChiFdcSdR,cplGluFdcSdL,           & 
& cplGluFdcSdR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_BLSSM_GluToFdcSd


Subroutine Amplitude_Tree_BLSSM_GluToFucSu(cplGluFucSuL,cplGluFucSuR,MFu,             & 
...
Amp(:,gt2, gt3) = AmpC 
    End Do
  End Do
End Subroutine Amplitude_Tree_BLSSM_GluToFucSu


Subroutine Gamma_Real_BLSSM_GluToFucSu(MLambda,em,gs,cplGluFucSuL,cplGluFucSuR,       & 
...
End if 
    End Do
  End Do
End Subroutine Gamma_Real_BLSSM_GluToFucSu


Subroutine Amplitude_WAVE_BLSSM_GluToFucSu(cplGluFucSuL,cplGluFucSuR,ctcplGluFucSuL,  & 
...
Amp(:,gt2, gt3) = AmpC 
    End Do
  End Do
End Subroutine Amplitude_WAVE_BLSSM_GluToFucSu


Subroutine Amplitude_VERTEX_BLSSM_GluToFucSu(MAh,MCha,MChi,MFd,MFu,MGlu,              & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
Amp(:,gt2, gt3) = Amp(:,gt2, gt3) + oo16pi2*(-3._dp/2._dp*(0.,1._dp))*AmpC 
    ...
    End Do
  End Do
End Subroutine Amplitude_VERTEX_BLSSM_GluToFucSu


Subroutine Amplitude_IR_VERTEX_BLSSM_GluToFucSu(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplcFuFuAhL,cplcFuFuAhR,               & 
& cplAhSucSu,cplChaFucSdL,cplChaFucSdR,cplChiFucSuL,cplChiFucSuR,cplGluFdcSdL,           & 
& cplGluFdcSdR,cplcChaFdcSuL,cplcChaFdcSuR,cplGluFucSuL,cplGluFucSuR,cplcFuFuhhL,        & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_BLSSM_GluToFucSu


Subroutine Amplitude_WAVE_BLSSM_GluToChiVG(MChi,MChi2,MGlu,MGlu2,MVG,MVG2,            & 
& ZffG,ZfL0,ZfVG,Amp)
...
Amp(:,gt2) = 0._dp
  End Do
End Subroutine Amplitude_WAVE_BLSSM_GluToChiVG


Subroutine Amplitude_VERTEX_BLSSM_GluToChiVG(MChi,MFd,MFu,MGlu,MSd,MSu,               & 
...
End Do
  End Do
End Subroutine Amplitude_VERTEX_BLSSM_GluToChiVG


Subroutine Amplitude_IR_VERTEX_BLSSM_GluToChiVG(MChi,MFd,MFu,MGlu,MSd,MSu,            & 
& MVG,MChi2,MFd2,MFu2,MGlu2,MSd2,MSu2,MVG2,cplChiFdcSdL,cplChiFdcSdR,cplChiFucSuL,       & 
& cplChiFucSuR,cplcFdChiSdL,cplcFdChiSdR,cplcFuChiSuL,cplcFuChiSuR,cplGluFdcSdL,         & 
& cplGluFdcSdR,cplcFdFdVGL,cplcFdFdVGR,cplGluFucSuL,cplGluFucSuR,cplcFuFuVGL,            & 
& cplcFuFuVGR,cplcFdGluSdL,cplcFdGluSdR,cplcFuGluSuL,cplcFuGluSuR,cplSdcSdVG,            & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_BLSSM_GluToChiVG


Subroutine Amplitude_WAVE_BLSSM_GluToGluAh(MAh,MAh2,MGlu,MGlu2,ZfAh,ZffG,Amp)
...
Amp(:,gt3) = 0._dp
    End Do
End Subroutine Amplitude_WAVE_BLSSM_GluToGluAh


Subroutine Amplitude_VERTEX_BLSSM_GluToGluAh(MAh,MFd,MFu,MGlu,MSd,MSu,MAh2,           & 
...
End Do
    End Do
End Subroutine Amplitude_VERTEX_BLSSM_GluToGluAh


Subroutine Amplitude_IR_VERTEX_BLSSM_GluToGluAh(MAh,MFd,MFu,MGlu,MSd,MSu,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_BLSSM_GluToGluAh


Subroutine Amplitude_WAVE_BLSSM_GluToGluhh(MGlu,MGlu2,Mhh,Mhh2,ZffG,Zfhh,Amp)

Implicit None

Real(dp), Intent(in) :: MGlu,MGlu2,Mhh(4),Mhh2(4)

Complex(dp), Intent(in) :: ZffG,Zfhh(4,4)
...
Amp(:,gt3) = 0._dp
    End Do
End Subroutine Amplitude_WAVE_BLSSM_GluToGluhh


Subroutine Amplitude_VERTEX_BLSSM_GluToGluhh(MFd,MFu,MGlu,Mhh,MSd,MSu,MFd2,           & 
...
Real(dp), Intent(in) :: MFd(3),MFu(3),MGlu,Mhh(4),MSd(6),MSu(6),MFd2(3),MFu2(3),MGlu2,Mhh2(4),MSd2(6),MSu2(6)

Complex(dp), Intent(in) :: cplGluFdcSdL(3,6),cplGluFdcSdR(3,6),cplcFdFdhhL(3,3,4),cplcFdFdhhR(3,3,4),            & 
& cplGluFucSuL(3,6),cplGluFucSuR(3,6),cplcFuFuhhL(3,3,4),cplcFuFuhhR(3,3,4),             & 
& cplcFdGluSdL(3,6),cplcFdGluSdR(3,6),cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),               & 
& cplhhSdcSd(4,6,6),cplhhSucSu(4,6,6)
...
End Do
    End Do
End Subroutine Amplitude_VERTEX_BLSSM_GluToGluhh


Subroutine Amplitude_IR_VERTEX_BLSSM_GluToGluhh(MFd,MFu,MGlu,Mhh,MSd,MSu,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_BLSSM_GluToGluhh


Subroutine Amplitude_WAVE_BLSSM_GluToGluVG(cplGluGluVGL,cplGluGluVGR,ctcplGluGluVGL,  & 
...
Amp(:) = -AmpC 
End Subroutine Amplitude_WAVE_BLSSM_GluToGluVG


Subroutine Amplitude_VERTEX_BLSSM_GluToGluVG(MFd,MFu,MGlu,MSd,MSu,MVG,MFd2,           & 
...
Amp(:) = Amp(:) + oo16pi2*(1._dp/4._dp)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_BLSSM_GluToGluVG


Subroutine Amplitude_IR_VERTEX_BLSSM_GluToGluVG(MFd,MFu,MGlu,MSd,MSu,MVG,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_BLSSM_GluToGluVG


Subroutine Amplitude_WAVE_BLSSM_GluToGluVP(MGlu,MGlu2,MVP,MVP2,ZffG,ZfVP,Amp)
...
! External Field 3 
Amp(:) = 0._dp
End Subroutine Amplitude_WAVE_BLSSM_GluToGluVP


Subroutine Amplitude_VERTEX_BLSSM_GluToGluVP(MFd,MFu,MGlu,MSd,MSu,MVP,MFd2,           & 
...
Amp(:) = Amp(:) + oo16pi2*(1._dp/2._dp)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_BLSSM_GluToGluVP


Subroutine Amplitude_IR_VERTEX_BLSSM_GluToGluVP(MFd,MFu,MGlu,MSd,MSu,MVP,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_BLSSM_GluToGluVP


Subroutine Amplitude_WAVE_BLSSM_GluToGluVZ(MGlu,MGlu2,MVZ,MVZ2,ZffG,ZfVZ,Amp)
...
! External Field 3 
Amp(:) = 0._dp
End Subroutine Amplitude_WAVE_BLSSM_GluToGluVZ


Subroutine Amplitude_VERTEX_BLSSM_GluToGluVZ(MFd,MFu,MGlu,MSd,MSu,MVZ,MFd2,           & 
...
Amp(:) = Amp(:) + oo16pi2*(1._dp/2._dp)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_BLSSM_GluToGluVZ


Subroutine Amplitude_IR_VERTEX_BLSSM_GluToGluVZ(MFd,MFu,MGlu,MSd,MSu,MVZ,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_BLSSM_GluToGluVZ


Subroutine Amplitude_WAVE_BLSSM_GluToGluVZp(MGlu,MGlu2,MVZp,MVZp2,ZffG,               & 
& ZfVZp,Amp)
...
! External Field 3 
Amp(:) = 0._dp
End Subroutine Amplitude_WAVE_BLSSM_GluToGluVZp


Subroutine Amplitude_VERTEX_BLSSM_GluToGluVZp(MFd,MFu,MGlu,MSd,MSu,MVZp,              & 
...
Amp(:) = Amp(:) + oo16pi2*(1._dp/2._dp)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_BLSSM_GluToGluVZp


Subroutine Amplitude_IR_VERTEX_BLSSM_GluToGluVZp(MFd,MFu,MGlu,MSd,MSu,MVZp,           & 
& MFd2,MFu2,MGlu2,MSd2,MSu2,MVZp2,cplGluFdcSdL,cplGluFdcSdR,cplcFdFdVZpL,cplcFdFdVZpR,   & 
& cplGluFucSuL,cplGluFucSuR,cplcFuFuVZpL,cplcFuFuVZpR,cplcFdGluSdL,cplcFdGluSdR,         & 
& cplcFuGluSuL,cplcFuGluSuR,cplSdcSdVZp,cplSucSuVZp,Amp)
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_BLSSM_GluToGluVZp



End Module OneLoopDecay_Glu_BLSSM

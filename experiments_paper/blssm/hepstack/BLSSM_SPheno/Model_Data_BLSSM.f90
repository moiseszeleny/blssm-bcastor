...
Real(dp) :: ZPOS_0(2, 2)
Real(dp) :: ZPOS_p2(2, 2)
Complex(dp) :: ZNOS_0(7, 7)
Complex(dp) :: ZNOS_p2(7, 7)
...
Complex(dp) :: Bmu1L 
Complex(dp) :: Bmu2L 
Real(dp) :: mass_uncertainty_Q(65), mass_uncertainty_Yt(65), g_SM_save(62) 
...
Real(dp) :: g1IN,g2IN,g3IN,gBLIN,gYBIN,gBYIN

Complex(dp) :: YdIN(3,3),YeIN(3,3),YuIN(3,3),YxIN(3,3),YvIN(3,3)

Real(dp) :: g1MZ,g2MZ,g3MZ,gBLMZ,gYBMZ,gBYMZ

Complex(dp) :: YdMZ(3,3),YeMZ(3,3),YuMZ(3,3),YxMZ(3,3),YvMZ(3,3)

Real(dp) :: g1GUT,g2GUT,g3GUT,gBLGUT,gYBGUT,gBYGUT

Complex(dp) :: YdGUT(3,3),YeGUT(3,3),YuGUT(3,3),YxGUT(3,3),YvGUT(3,3)

Real(dp) :: mHd2IN,mHu2IN,mC12IN,mC22IN

Complex(dp) :: MuPIN,MuIN,TdIN(3,3),TeIN(3,3),TuIN(3,3),TxIN(3,3),TvIN(3,3),BMuPIN,BmuIN,            & 
& mq2IN(3,3),ml2IN(3,3),md2IN(3,3),mu2IN(3,3),me2IN(3,3),mv2IN(3,3),MBBpIN,              & 
& M1IN,M2IN,M3IN,MBpIN

Real(dp) :: mHd2MZ,mHu2MZ,mC12MZ,mC22MZ

Complex(dp) :: MuPMZ,MuMZ,TdMZ(3,3),TeMZ(3,3),TuMZ(3,3),TxMZ(3,3),TvMZ(3,3),BMuPMZ,BmuMZ,            & 
& mq2MZ(3,3),ml2MZ(3,3),md2MZ(3,3),mu2MZ(3,3),me2MZ(3,3),mv2MZ(3,3),MBBpMZ,              & 
& M1MZ,M2MZ,M3MZ,MBpMZ

Real(dp) :: mHd2GUT,mHu2GUT,mC12GUT,mC22GUT

Complex(dp) :: MuPGUT,MuGUT,TdGUT(3,3),TeGUT(3,3),TuGUT(3,3),TxGUT(3,3),TvGUT(3,3),BMuPGUT,          & 
& BmuGUT,mq2GUT(3,3),ml2GUT(3,3),md2GUT(3,3),mu2GUT(3,3),me2GUT(3,3),mv2GUT(3,3),        & 
& MBBpGUT,M1GUT,M2GUT,M3GUT,MBpGUT
...
Real(dp) :: vdIN,vuIN,x1IN,x2IN

Real(dp) :: vdFix,vuFix,x1Fix,x2Fix

Real(dp) :: gPSd(6,2064),gTSd(6),BRSd(6,2064),gPSu(6,2064),gTSu(6),BRSu(6,2064),gPSe(6,2193),     & 
...
Real(dp) :: gP1LSd(6,102),gT1LSd(6),BR1LSd(6,102),gP1LSu(6,102),gT1LSu(6),BR1LSu(6,102),          & 
& gP1LSe(6,111),gT1LSe(6),BR1LSe(6,111),gP1LSvRe(6,168),gT1LSvRe(6),BR1LSvRe(6,168),     & 
& gP1LSvIm(6,168),gT1LSvIm(6),BR1LSvIm(6,168),gP1Lhh(4,320),gT1Lhh(4),BR1Lhh(4,320),     & 
& gP1LAh(4,318),gT1LAh(4),BR1LAh(4,318),gP1LHpm(2,167),gT1LHpm(2),BR1LHpm(2,167),        & 
& gP1LVZp(1,243),gT1LVZp,BR1LVZp(1,243),gP1LGlu(1,53),gT1LGlu,BR1LGlu(1,53),             & 
& gP1LCha(2,140),gT1LCha(2),BR1LCha(2,140),gP1LChi(7,194),gT1LChi(7),BR1LChi(7,194),     & 
& gP1LFu(3,96),gT1LFu(3),BR1LFu(3,96),gP1LFv(6,156),gT1LFv(6),BR1LFv(6,156)
...
Real(dp) :: ratioPCha(4,2),ratioPFd(4,3),ratioPFe(4,3),ratioPFu(4,3),ratioPHpm(4,2),              & 
& ratioPSd(4,6),ratioPSe(4,6),ratioPSu(4,6),ratioPVWm(4)

Complex(dp) :: ratioPGG(4),ratioPPP(4)

Real(dp) :: TanBetaQ
Real(dp) :: gForTadpoles(320)
...
Logical, save :: InputValueforTx =.False. 
Logical, save :: InputValueforTv =.False. 
Logical, save :: InputValueforBMuP =.False. 
...
Logical, save :: InputValueformC12 =.False. 
Logical, save :: InputValueformC22 =.False. 
Logical, save :: InputValueforMBBp =.False. 
Logical, save :: InputValueforM1 =.False. 
Logical, save :: InputValueforM2 =.False. 
Logical, save :: InputValueforM3 =.False. 
Logical, save :: InputValueforMBp =.False. 
Logical, save :: InputValueforx1 =.False. 
Logical, save :: InputValueforx2 =.False. 
Real (dp) :: vSM_Q 
...
Complex(dp) :: SignumMu
Complex(dp) :: Azero
Complex(dp) :: SignumMuP
Real(dp) :: TBetaP
Complex(dp) :: MZp
Real(dp) :: gBLinput
Complex(dp) :: g1BLinput
Complex(dp) :: MuInput
Complex(dp) :: MuPInput
Complex(dp) :: BMuInput
Complex(dp) :: BMuPInput
Real(dp) :: vdMZ 
Real(dp) :: vdSUSY 
Real(dp) :: vuMZ 
Real(dp) :: vuSUSY 
...
Real(dp) :: x2SUSY 
! For HiggsBounds 
Real(dp) :: BR_HpHW(2,4)  = 0._dp
Real(dp) :: BR_HpAW(2,4) = 0._dp
...
Azero=(0._dp,0._dp) 
SignumMuP=(0._dp,0._dp) 
TBetaP= 0._dp 
MZp=(0._dp,0._dp) 
gBLinput= 0._dp 
g1BLinput=(0._dp,0._dp)
MuInput=(0._dp,0._dp)
MuPInput=(0._dp,0._dp)
BMuInput=(0._dp,0._dp)
BMuPInput=(0._dp,0._dp)
End Subroutine Set_All_Parameters_0 
 


Subroutine SetMatchingConditions(g1SM,g2SM,g3SM,YuSM,YdSM,YeSM,vSM,vd,vu,             & 
& x1,x2,g1,g2,g3,gBL,gYB,gBY,Yd,Ye,Yu,Yx,Yv,MuP,Mu,Td,Te,Tu,Tx,Tv,BMuP,Bmu,              & 
& mq2,ml2,mHd2,mHu2,md2,mu2,me2,mv2,mC12,mC22,MBBp,M1,M2,M3,MBp,MZsuffix)

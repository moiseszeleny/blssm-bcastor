...
Use StandardModel 
Use RunSM_BLSSM
Use FlavorKit_LFV_BLSSM
Use FlavorKit_QFV_BLSSM
Use FlavorKit_Observables_BLSSM
...
& MFv2,Mhh,Mhh2,MHpm,MHpm2,MSe,MSe2,MSvIm,MSvIm2,MSvRe,MSvRe2,MVZp,MVZp2,cplcFeFeAhL,    & 
& cplcFeFeAhR,cplAhhhVP,cplcFeChaSvImL,cplcFeChaSvImR,cplcFeChaSvReL,cplcFeChaSvReR,     & 
& cplcChaChaVPL,cplcChaChaVPR,cplChiChiVPL,cplChiChiVPR,cplChiFecSeL,cplChiFecSeR,       & 
& cplcFeChiSeL,cplcFeChiSeR,cplFvFecHpmL,cplFvFecHpmR,cplcFeFehhL,cplcFeFehhR,           & 
& cplcChaFeSvImL,cplcChaFeSvImR,cplcChaFeSvReL,cplcChaFeSvReR,cplcFeFeVPL,               & 
& cplcFeFeVPR,cplcFeFeVZpL,cplcFeFeVZpR,cplFvFvVPL,cplFvFvVPR,cplcFeFvHpmL,              & 
& cplcFeFvHpmR,cplHpmcHpmVP,cplSecSeVP,cplSvImSvReVP,a_mu)

Real(dp),Intent(in)  :: MAh(4),MAh2(4),MCha(2),MCha2(2),MChi(7),MChi2(7),MFe(3),MFe2(3),MFv(6),               & 
& MFv2(6),Mhh(4),Mhh2(4),MHpm(2),MHpm2(2),MSe(6),MSe2(6),MSvIm(6),MSvIm2(6),             & 
& MSvRe(6),MSvRe2(6),MVZp,MVZp2

Complex(dp),Intent(in)  :: cplcFeFeAhL(3,3,4),cplcFeFeAhR(3,3,4),cplAhhhVP(4,4),cplcFeChaSvImL(3,2,6),           & 
& cplcFeChaSvImR(3,2,6),cplcFeChaSvReL(3,2,6),cplcFeChaSvReR(3,2,6),cplcChaChaVPL(2,2),  & 
& cplcChaChaVPR(2,2),cplChiChiVPL(7,7),cplChiChiVPR(7,7),cplChiFecSeL(7,3,6),            & 
& cplChiFecSeR(7,3,6),cplcFeChiSeL(3,7,6),cplcFeChiSeR(3,7,6),cplFvFecHpmL(6,3,2),       & 
& cplFvFecHpmR(6,3,2),cplcFeFehhL(3,3,4),cplcFeFehhR(3,3,4),cplcChaFeSvImL(2,3,6),       & 
& cplcChaFeSvImR(2,3,6),cplcChaFeSvReL(2,3,6),cplcChaFeSvReR(2,3,6),cplcFeFeVPL(3,3),    & 
& cplcFeFeVPR(3,3),cplcFeFeVZpL(3,3),cplcFeFeVZpR(3,3),cplFvFvVPL(6,6),cplFvFvVPR(6,6),  & 
& cplcFeFvHpmL(3,6,2),cplcFeFvHpmR(3,6,2),cplHpmcHpmVP(2,2),cplSecSeVP(6,6),             & 
& cplSvImSvReVP(6,6)
...
Do i1= 1,2
  Do i2= 1,6
   i3 = i2
  If ((MCha2(i1).gt.mz2).Or.(MSvRe2(i2).gt.mz2).Or.(MSvIm2(i3).gt.mz2)) Then
coup1L = cplcFeChaSvReL(gt1,i1,i2)
coup1R = cplcFeChaSvReR(gt1,i1,i2)
coup2L = cplcChaFeSvImL(i1,gt2,i3)
coup2R = cplcChaFeSvImR(i1,gt2,i3)
ratio = MSvRe2(i2)/MCha2(i1)
 chargefactor = chargefactor*(0._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - chargefactor*(2._dp*Real(coup1L*Conjg(coup1R),dp)*F4(ratio)/MCha(i1)& 
      & +2._dp*MFe(Ifermion)*(Abs(coup1L)**2 + Abs(coup1R)**2)*F1(ratio)/MCha2(i1)) 
End if 
...
Do i1= 1,2
  Do i2= 1,6
   i3 = i2
  If ((MCha2(i1).gt.mz2).Or.(MSvIm2(i2).gt.mz2).Or.(MSvRe2(i3).gt.mz2)) Then
coup1L = cplcFeChaSvImL(gt1,i1,i2)
coup1R = cplcFeChaSvImR(gt1,i1,i2)
coup2L = cplcChaFeSvReL(i1,gt2,i3)
coup2R = cplcChaFeSvReR(i1,gt2,i3)
ratio = MSvIm2(i2)/MCha2(i1)
 chargefactor = chargefactor*(0._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - chargefactor*(2._dp*Real(coup1L*Conjg(coup1R),dp)*F4(ratio)/MCha(i1)& 
      & +2._dp*MFe(Ifermion)*(Abs(coup1L)**2 + Abs(coup1R)**2)*F1(ratio)/MCha2(i1)) 
...
Do i1= 1,6
  Do i2= 1,7
   i3 = i2
  If ((MSe2(i1).gt.mz2).Or.(MChi2(i2).gt.mz2).Or.(MChi2(i3).gt.mz2)) Then
coup1L = cplcFeChiSeL(gt1,i2,i1)
coup1R = cplcFeChiSeR(gt1,i2,i1)
coup2L = cplChiFecSeL(i3,gt2,i1)
coup2R = cplChiFecSeR(i3,gt2,i1)
ratio = MSe2(i1)/MChi2(i2)
 chargefactor = chargefactor*(0._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - chargefactor*(Real(coup1L*Conjg(coup1R),dp)*F3gamma(ratio)/MChi(i2)& 
...
& MVZ2,MVZp,MVZp2,cplcFeFeAhL,cplcFeFeAhR,cplAhhhVP,cplcFeChaSvImL,cplcFeChaSvImR,       & 
...
& cplcFeFeVZpL,cplcFeFeVZpR,cplFvFvVPL,cplFvFvVPR,cplcFeFvHpmL,cplcFeFvHpmR,             & 
& cplcFeFvVWmL,cplcFeFvVWmR,cplHpmcHpmVP,cplSecSeVP,cplSvImSvReVP,cplcVWmVPVWm,EDM)

Implicit None
Real(dp),Intent(in)  :: MAh(4),MAh2(4),MCha(2),MCha2(2),MChi(7),MChi2(7),MFe(3),MFe2(3),MFv(6),               & 
& MFv2(6),Mhh(4),Mhh2(4),MHpm(2),MHpm2(2),MSe(6),MSe2(6),MSvIm(6),MSvIm2(6),             & 
& MSvRe(6),MSvRe2(6),MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2
...
& cplcFeFeVZR(3,3),cplcFeFeVZpL(3,3),cplcFeFeVZpR(3,3),cplFvFvVPL(6,6),cplFvFvVPR(6,6),  & 
& cplcFeFvHpmL(3,6,2),cplcFeFvHpmR(3,6,2),cplcFeFvVWmL(3,6),cplcFeFvVWmR(3,6),           & 
& cplHpmcHpmVP(2,2),cplSecSeVP(6,6),cplSvImSvReVP(6,6),cplcVWmVPVWm
...
coup2L = cplcChaFeSvImL(i1,gt2,i3)
coup2R = cplcChaFeSvImR(i1,gt2,i3)
!ratio = MCha2(i1)/MSvRe2(i2)
 !If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
!EDM = EDM +(0)* chargefactor*Aimag(coup1L*Conjg(coup1R))*FeynFunctionB(ratio)*MCha(i1)/MSvRe2(i2) 
!End if 
 
ratio = MSvRe2(i2)/MCha2(i1)
 chargefactor = chargefactor*(0._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
EDM = EDM - chargefactor*(Aimag(coup1L*Conjg(coup1R))*F4(ratio)/MCha(i1)) 
End if 
...
coup2L = cplcChaFeSvReL(i1,gt2,i3)
coup2R = cplcChaFeSvReR(i1,gt2,i3)
!ratio = MCha2(i1)/MSvIm2(i2)
 !If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
!EDM = EDM +(0)* chargefactor*Aimag(coup1L*Conjg(coup1R))*FeynFunctionB(ratio)*MCha(i1)/MSvIm2(i2) 
!End if 
...
coup2L = cplChiFecSeL(i3,gt2,i1)
coup2R = cplChiFecSeR(i3,gt2,i1)
!ratio = MChi2(i2)/MSe2(i1)
 !If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
!EDM = EDM -(0)* chargefactor*Aimag(coup1R*Conjg(coup1L))*FeynFunctionA(ratio)*MChi(i2)/MSe2(i1) 
!End if 
 
ratio = MSe2(i1)/MChi2(i2)
 chargefactor = chargefactor*(0._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
EDM = EDM - 0.5_dp*chargefactor*(Aimag(coup1L*Conjg(coup1R))*F3gamma(ratio)/MChi(i2)) 
End if 
...
!ratio = MCha2(i2)/MSvIm2(i1)
 !If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
!EDM = EDM -(-1)* chargefactor*Aimag(coup1R*Conjg(coup1L))*FeynFunctionA(ratio)*MCha(i2)/MSvIm2(i1) 
!End if 
...
!ratio = MCha2(i2)/MSvRe2(i1)
 !If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
!EDM = EDM -(-1)* chargefactor*Aimag(coup1R*Conjg(coup1L))*FeynFunctionA(ratio)*MCha(i2)/MSvRe2(i1) 
!End if 
...
& MSvRe,MSvRe2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhcVWmVWm,cplAhAhVZVZ,cplAhhhVZ,      & 
& cplAhHpmcVWm,cplcChaChaVZL,cplcChaChaVZR,cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVZL,          & 
& cplcFeFeVZR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuVZL,cplcFuFuVZR,cplcgAgWmcVWm,         & 
& cplcgWmgWmVZ,cplcgWpCgAcVWm,cplcgWpCgWpCVZ,cplcgWpCgZcVWm,cplcgWpCgZpcVWm,             & 
& cplcgZgWmcVWm,cplcgZpgWmcVWm,cplChiChacVWmL,cplChiChacVWmR,cplChiChiVZL,               & 
...
& cplhhhhcVWmVWm,cplhhhhVZVZ,cplhhHpmcVWm,cplhhVPVZ,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmcVWmVWm,& 
& cplHpmcHpmVZ,cplHpmcHpmVZVZ,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdcVWmVWm,   & 
& cplSdcSdVZ,cplSdcSdVZVZ,cplSdcSucVWm,cplSecSecVWmVWm,cplSecSeVZ,cplSecSeVZVZ,          & 
& cplSeSvImcVWm,cplSeSvRecVWm,cplSucSucVWmVWm,cplSucSuVZ,cplSucSuVZVZ,cplSvImSvImcVWmVWm,& 
& cplSvImSvImVZVZ,cplSvImSvReVZ,cplSvReSvRecVWmVWm,cplSvReSvReVZVZ,rho)
...
Complex(dp),Intent(in)  :: cplAhAhcVWmVWm(4,4),cplAhAhVZVZ(4,4),cplAhhhVZ(4,4),cplAhHpmcVWm(4,2),cplcChaChaVZL(2,2),& 
...
& cplcgWpCgZpcVWm,cplcgZgWmcVWm,cplcgZpgWmcVWm,cplChiChacVWmL(7,2),cplChiChacVWmR(7,2),  & 
& cplChiChiVZL(7,7),cplChiChiVZR(7,7),cplcVWmcVWmVWmVWm1,cplcVWmcVWmVWmVWm2,             & 
...
& cplFvFvVZL(6,6),cplFvFvVZR(6,6),cplhhcVWmVWm(4),cplhhhhcVWmVWm(4,4),cplhhhhVZVZ(4,4),  & 
& cplhhHpmcVWm(4,2),cplhhVPVZ(4),cplhhVZVZ(4),cplhhVZVZp(4),cplHpmcHpmcVWmVWm(2,2),      & 
...
& cplSecSecVWmVWm(6,6),cplSecSeVZ(6,6),cplSecSeVZVZ(6,6),cplSeSvImcVWm(6,6),             & 
& cplSeSvRecVWm(6,6),cplSucSucVWmVWm(6,6),cplSucSuVZ(6,6),cplSucSuVZVZ(6,6),             & 
& cplSvImSvImcVWmVWm(6,6),cplSvImSvImVZVZ(6,6),cplSvImSvReVZ(6,6),cplSvReSvRecVWmVWm(6,6),& 
& cplSvReSvReVZVZ(6,6)
...
& MVZp,MVZp2,cplAhhhVP,cplcChaChaVPL,cplcChaChaVPR,cplChiChiVPL,cplChiChiVPR,            & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFeFeVPL,cplcFeFeVPR,cplcFuFuVPL,cplcFuFuVPR,               & 
& cplFvFvVPL,cplFvFvVPR,cplcgWmgWmVP,cplcgWpCgWpCVP,cplhhVPVZ,cplhhVPVZp,cplHpmcHpmVP,   & 
& cplHpmcVWmVP,cplSdcSdVP,cplSecSeVP,cplSucSuVP,cplSvImSvReVP,cplcVWmVPVWm,              & 
& cplAhAhVPVP,cplhhhhVPVP,cplHpmcHpmVPVP,cplSdcSdVPVP,cplSecSeVPVP,cplSucSuVPVP,         & 
& cplSvImSvImVPVP,cplSvReSvReVPVP,cplcVWmVPVPVWm1,cplcVWmVPVPVWm2,cplcVWmVPVPVWm3,       & 
...
& cplSdcSdVZ,cplSecSeVZ,cplSucSuVZ,cplSvImSvReVZ,cplcVWmVWmVZ,cplAhAhVZVZ,               & 
& cplhhhhVZVZ,cplHpmcHpmVZVZ,cplSdcSdVZVZ,cplSecSeVZVZ,cplSucSuVZVZ,cplSvImSvImVZVZ,     & 
& cplSvReSvReVZVZ,cplcVWmVWmVZVZ1,cplcVWmVWmVZVZ2,cplcVWmVWmVZVZ3,cplHpmcVWmVZp,         & 
& cplcVWmVWmVZp,cplcVWmVWmVZpVZp1,cplcVWmVWmVZpVZp2,cplcVWmVWmVZpVZp3,cplAhHpmcVWm,      & 
...
& cplcgWpCgZpcVWm,cplhhHpmcVWm,cplhhcVWmVWm,cplSdcSucVWm,cplSeSvImcVWm,cplSeSvRecVWm,    & 
...
& cplcVWmcVWmVWmVWm2,cplcVWmcVWmVWmVWm3,cplcHpmVWmVZ,cplcHpmVPVWm,cplAhAhVPVZ,           & 
& cplhhhhVPVZ,cplHpmcHpmVPVZ,cplSdcSdVPVZ,cplSecSeVPVZ,cplSucSuVPVZ,cplSvImSvImVPVZ,     & 
& cplSvReSvReVPVZ,cplcVWmVPVWmVZ1,cplcVWmVPVWmVZ2,cplcVWmVPVWmVZ3,cplcHpmVWmVZp,         & 
& cplAhAhVPVZp,cplhhhhVPVZp,cplHpmcHpmVPVZp,cplSdcSdVPVZp,cplSecSeVPVZp,cplSucSuVPVZp,   & 
& cplSvImSvImVPVZp,cplSvReSvReVPVZp,cplcVWmVPVWmVZp1,cplcVWmVPVWmVZp2,cplcVWmVPVWmVZp3,  & 
& cplAhAhVZVZp,cplhhhhVZVZp,cplHpmcHpmVZVZp,cplSdcSdVZVZp,cplSecSeVZVZp,cplSucSuVZVZp,   & 
& cplSvImSvImVZVZp,cplSvReSvReVZVZp,cplcVWmVWmVZVZp1,cplcVWmVWmVZVZp2,cplcVWmVWmVZVZp3,  & 
& Spar,Tpar,Upar)
...
Call Pi1LoopVPVZ(MVZ2,MAh,MAh2,MCha,MCha2,MChi,MChi2,MFd,MFd2,MFe,MFe2,               & 
...
& cplSvImSvReVP,cplSvImSvReVZ,cplSvReSvReVPVZ,kont,PiZg_mz2)

Call Pi1LoopVP(MVZ2,Mhh,Mhh2,MAh,MAh2,MCha,MCha2,MChi,MChi2,MFd,MFd2,MFe,             & 
& MFe2,MFu,MFu2,MFv,MFv2,MVZ,MVZ2,MVZp,MVZp2,MHpm,MHpm2,MVWm,MVWm2,MSd,MSd2,             & 
...
Subroutine CalculateLowEnergyConstraints(g1input,g2input,g3input,gBLinput,            & 
& gYBinput,gBYinput,Ydinput,Yeinput,Yuinput,Yxinput,Yvinput,MuPinput,Muinput,            & 
& Tdinput,Teinput,Tuinput,Txinput,Tvinput,BMuPinput,Bmuinput,mq2input,ml2input,          & 
& mHd2input,mHu2input,md2input,mu2input,me2input,mv2input,mC12input,mC22input,           & 
& MBBpinput,M1input,M2input,M3input,MBpinput,vdinput,vuinput,x1input,x2input,            & 
...
Real(dp),Intent(inout) :: g1input,g2input,g3input,gBLinput,gYBinput,gBYinput,mHd2input,mHu2input,               & 
& mC12input,mC22input,vdinput,vuinput,x1input,x2input

Complex(dp),Intent(inout) :: Ydinput(3,3),Yeinput(3,3),Yuinput(3,3),Yxinput(3,3),Yvinput(3,3),MuPinput,            & 
...
Complex(dp) :: cplAhAhcVWmVWm(4,4),cplAhAhhh(4,4,4),cplAhAhVPVP(4,4),cplAhAhVPVZ(4,4),               & 
& cplAhAhVPVZp(4,4),cplAhAhVZVZ(4,4),cplAhAhVZVZp(4,4),cplAhcHpmVWm(4,2),cplAhhhVP(4,4), & 
& cplAhhhVZ(4,4),cplAhhhVZp(4,4),cplAhHpmcHpm(4,2,2),cplAhHpmcVWm(4,2),cplAhSdcSd(4,6,6),& 
...
& cplcgWpCgZpcVWm,cplcgZgWmcVWm,cplcgZpgWmcVWm,cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6),  & 
...
& cplChiChiVZpR(7,7),cplChiChiVZR(7,7),cplChiFdcSdL(7,3,6),cplChiFdcSdR(7,3,6),          & 
...
& cplcHpmVPVWm(2),cplcHpmVWmVZ(2),cplcHpmVWmVZp(2),cplcVWmcVWmVWmVWm1,cplcVWmcVWmVWmVWm2,& 
& cplcVWmcVWmVWmVWm3,cplcVWmVPVPVWm1,cplcVWmVPVPVWm2,cplcVWmVPVPVWm3,cplcVWmVPVWm,       & 
...
Complex(dp) :: cplcVWmVWmVZpVZp3,cplcVWmVWmVZVZ1,cplcVWmVWmVZVZ2,cplcVWmVWmVZVZ3,cplcVWmVWmVZVZp1,    & 
& cplcVWmVWmVZVZp2,cplcVWmVWmVZVZp3,cplFvChacSeL(6,2,6),cplFvChacSeR(6,2,6),             & 
...
& cplFvFvVZR(6,6),cplGluFdcSdL(3,6),cplGluFdcSdR(3,6),cplGluFucSuL(3,6),cplGluFucSuR(3,6),& 
& cplGluGluVGL,cplGluGluVGR,cplhhcHpmVWm(4,2),cplhhcVWmVWm(4),cplhhhhcVWmVWm(4,4),       & 
& cplhhhhhh(4,4,4),cplhhhhVPVP(4,4),cplhhhhVPVZ(4,4),cplhhhhVPVZp(4,4),cplhhhhVZVZ(4,4), & 
& cplhhhhVZVZp(4,4),cplhhHpmcHpm(4,2,2),cplhhHpmcVWm(4,2),cplhhSdcSd(4,6,6),             & 
...
& cplhhVZVZp(4),cplHpmcHpmcVWmVWm(2,2),cplHpmcHpmVP(2,2),cplHpmcHpmVPVP(2,2),            & 
& cplHpmcHpmVPVZ(2,2),cplHpmcHpmVPVZp(2,2),cplHpmcHpmVZ(2,2),cplHpmcHpmVZp(2,2),         & 
& cplHpmcHpmVZVZ(2,2),cplHpmcHpmVZVZp(2,2),cplHpmcVWmVP(2),cplHpmcVWmVZ(2),              & 
& cplHpmcVWmVZp(2),cplHpmSucSd(2,6,6),cplHpmSvImcSe(2,6,6),cplHpmSvRecSe(2,6,6),         & 
& cplSdcHpmcSu(6,2,6),cplSdcSdcVWmVWm(6,6),cplSdcSdVG(6,6),cplSdcSdVP(6,6),              & 
& cplSdcSdVPVP(6,6),cplSdcSdVPVZ(6,6),cplSdcSdVPVZp(6,6),cplSdcSdVZ(6,6),cplSdcSdVZp(6,6),& 
& cplSdcSdVZVZ(6,6),cplSdcSdVZVZp(6,6),cplSdcSucVWm(6,6),cplSecSecVWmVWm(6,6),           & 
& cplSecSeVP(6,6),cplSecSeVPVP(6,6),cplSecSeVPVZ(6,6),cplSecSeVPVZp(6,6),cplSecSeVZ(6,6),& 
& cplSecSeVZp(6,6),cplSecSeVZVZ(6,6),cplSecSeVZVZp(6,6),cplSeSvImcHpm(6,6,2),            & 
...
& cplSucSuVPVZp(6,6),cplSucSuVZ(6,6),cplSucSuVZp(6,6),cplSucSuVZVZ(6,6),cplSucSuVZVZp(6,6),& 
& cplSvImcSeVWm(6,6),cplSvImSvImcVWmVWm(6,6),cplSvImSvImVPVP(6,6),cplSvImSvImVPVZ(6,6),  & 
& cplSvImSvImVPVZp(6,6),cplSvImSvImVZVZ(6,6),cplSvImSvImVZVZp(6,6),cplSvImSvReVP(6,6),   & 
& cplSvImSvReVZ(6,6),cplSvImSvReVZp(6,6),cplSvRecSeVWm(6,6),cplSvReSvRecVWmVWm(6,6),     & 
& cplSvReSvReVPVP(6,6),cplSvReSvReVPVZ(6,6),cplSvReSvReVPVZp(6,6),cplSvReSvReVZVZ(6,6),  & 
& cplSvReSvReVZVZp(6,6),cplVGVGVG
...
gBLinput = Sqrt(2._dp/3._dp)*gBLinput 
gYBinput = Sqrt(5._dp/3._dp)*gYBinput 
gBYinput = Sqrt(2._dp/3._dp)*gBYinput 
...
scale_save = Qin 
Call RunSM_and_SUSY_RGEs(160._dp,g1input,g2input,g3input,gBLinput,gYBinput,           & 
...
& md2,mu2,me2,mv2,mC12,mC22,MBBp,M1,M2,M3,MBp,vd,vu,x1,x2,CKM_160,sinW2_160,             & 
...
MHpm(1)=MVWm
MHpm2(1)=MVWm2
Call AllCouplings(g1,g2,gBL,gYB,gBY,vd,vu,x1,x2,ZH,ZA,ZP,Mu,Yd,Td,ZD,Ye,              & 
& Te,ZE,Yu,Tu,ZU,MuP,Yx,Tx,Yv,Tv,ZVI,ZVR,TW,TWp,g3,UM,UP,ZN,ZDL,ZDR,ZEL,ZER,             & 
...
& cplHpmSvRecSe,cplSdcHpmcSu,cplSeSvImcHpm,cplSeSvRecHpm,cplAhhhVP,cplAhhhVZ,            & 
...
& cplcHpmVPVWm,cplcHpmVWmVZ,cplcHpmVWmVZp,cplVGVGVG,cplcVWmVPVWm,cplcVWmVWmVZ,           & 
& cplcVWmVWmVZp,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,       & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplFvFvAhL,cplFvFvAhR,     & 
& cplChiChacHpmL,cplChiChacHpmR,cplChaFucSdL,cplChaFucSdR,cplFvChacSeL,cplFvChacSeR,     & 
& cplcChaChahhL,cplcChaChahhR,cplcFdChaSuL,cplcFdChaSuR,cplcFeChaSvImL,cplcFeChaSvImR,   & 
& cplcFeChaSvReL,cplcFeChaSvReR,cplChiChihhL,cplChiChihhR,cplChiFdcSdL,cplChiFdcSdR,     & 
...
& cplcFeFvVWmR,cplGluGluVGL,cplGluGluVGR)
...
& cplSvImSvReVZ,cplSvImSvReVZp,TSOddllSLL(gt1,gt2,gt3,gt4),TSOddllSRR(gt1,gt2,gt3,gt4)   & 
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvImSvReVP,     & 
& cplSvImSvReVZ,cplSvImSvReVZp,TVOddllSLL(gt1,gt2,gt3,gt4),TVOddllSRR(gt1,gt2,gt3,gt4)   & 
...
& cplcFuFuVZL,cplcFuFuVZpL,cplcFuFuVZpR,cplcFuFuVZR,cplChiChiAhL,cplChiChiAhR,           & 
& cplChiChihhL,cplChiChihhR,cplChiChiVPL,cplChiChiVPR,cplChiChiVZL,cplChiChiVZpL,        & 
& cplChiChiVZpR,cplChiChiVZR,cplChiFdcSdL,cplChiFdcSdR,cplChiFvSvImL,cplChiFvSvImR,      & 
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvImSvReVP,     & 
& cplSvImSvReVZ,cplSvImSvReVZp,TSOddvvVRR(gt1,gt2,gt3,gt4),TSOddvvVLL(gt1,gt2,gt3,gt4)   & 
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvImSvReVP,     & 
& cplSvImSvReVZ,cplSvImSvReVZp,TVOddvvVRR(gt1,gt2,gt3,gt4),TVOddvvVLL(gt1,gt2,gt3,gt4)   & 
...
& cplChiFdcSdL,cplChiFdcSdR,cplcHpmVPVWm,cplcHpmVWmVZ,cplcHpmVWmVZp,cplcVWmVPVWm,        & 
& cplcVWmVWmVZ,cplcVWmVWmVZp,cplGluFdcSdL,cplGluFdcSdR,cplGluGluVGL,cplGluGluVGR,        & 
& cplhhcHpmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSdcSd,              & 
& cplhhSucSu,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,         & 
...
& MChi2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,MGlu,MGlu2,Mhh,Mhh2,MHpm,MHpm2,              & 
& MSd,MSd2,MSe,MSe2,MSu,MSu2,MSvIm,MSvIm2,MSvRe,MSvRe2,MVWm,MVWm2,MVZ,MVZ2,              & 
& MVZp,MVZp2,cplAhcHpmVWm,cplAhHpmcHpm,cplAhHpmcVWm,cplcChacFuSdL,cplcChacFuSdR,         & 
...
& cplChiFvSvImL,cplChiFvSvImR,cplChiFvSvReL,cplChiFvSvReR,cplcHpmVWmVZ,cplcHpmVWmVZp,    & 
& cplcVWmVWmVZ,cplcVWmVWmVZp,cplFvChacSeL,cplFvChacSeR,cplFvFecHpmL,cplFvFecHpmR,        & 
...
& cplHpmcHpmVZp,cplHpmcVWmVZ,cplHpmcVWmVZp,cplHpmSvImcSe,cplHpmSvRecSe,cplSdcHpmcSu,     & 
& cplSdcSucVWm,cplSvImcSeVWm,cplSvRecSeVWm,TSOdulvSLL(gt1,gt2,gt3,gt4),TSOdulvSRR(gt1,gt2,gt3,gt4)& 
...
& cplGluFucSuR,cplhhcHpmVWm,cplhhcVWmVWm,cplhhHpmcHpm,cplhhHpmcVWm,cplHpmcHpmVZ,         & 
& cplHpmcHpmVZp,cplHpmcVWmVZ,cplHpmcVWmVZp,cplHpmSvImcSe,cplHpmSvRecSe,cplSdcHpmcSu,     & 
& cplSdcSucVWm,cplSvImcSeVWm,cplSvRecSeVWm,TVOdulvSLL(gt1,gt2,gt3,gt4),TVOdulvSRR(gt1,gt2,gt3,gt4)& 
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvImSvReVP,     & 
& cplSvImSvReVZ,cplSvImSvReVZp,BOddllSLL(gt1,gt2,gt3,gt4),BOddllSRR(gt1,gt2,gt3,gt4)     & 
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvImSvReVP,     & 
& cplSvImSvReVZ,cplSvImSvReVZp,PSOddllSLL(gt1,gt2,gt3,gt4),PSOddllSRR(gt1,gt2,gt3,gt4)   & 
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvImSvReVP,     & 
& cplSvImSvReVZ,cplSvImSvReVZp,PVOddllSLL(gt1,gt2,gt3,gt4),PVOddllSRR(gt1,gt2,gt3,gt4)   & 
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvImSvReVP,     & 
& cplSvImSvReVZ,cplSvImSvReVZp,BOddvvVRR(gt1,gt2,gt3,gt4),BOddvvVLL(gt1,gt2,gt3,gt4)     & 
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvImSvReVP,     & 
& cplSvImSvReVZ,cplSvImSvReVZp,PSOddvvVRR(gt1,gt2,gt3,gt4),PSOddvvVLL(gt1,gt2,gt3,gt4)   & 
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvImSvReVP,     & 
& cplSvImSvReVZ,cplSvImSvReVZp,PVOddvvVRR(gt1,gt2,gt3,gt4),PVOddvvVLL(gt1,gt2,gt3,gt4)   & 
...
& MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhhh,cplAhcHpmVWm,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,       & 
...
& cplSdcSdVZp,cplSucSuVG,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,BO4dSLL(gt1,gt2,gt3,gt4)      & 
...
& MFd,MFd2,MFu,MFu2,MGlu,MGlu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSu,MSu2,MVWm,               & 
& MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhhhVP,cplcChaChaVPL,cplcChaChaVPR,cplcChaFdcSuL,         & 
& cplcChaFdcSuR,cplcFdChaSuL,cplcFdChaSuR,cplcFdChiSdL,cplcFdChiSdR,cplcFdFdAhL,         & 
& cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,               & 
& cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFdFuHpmL,cplcFdFuHpmR,cplcFdFuVWmL,          & 
& cplcFdFuVWmR,cplcFdGluSdL,cplcFdGluSdR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdcVWmL,      & 
& cplcFuFdcVWmR,cplcFuFuVPL,cplcFuFuVPR,cplChiChiVPL,cplChiChiVPR,cplChiFdcSdL,          & 
& cplChiFdcSdR,cplcHpmVPVWm,cplcVWmVPVWm,cplGluFdcSdL,cplGluFdcSdR,cplhhVPVZ,            & 
& cplhhVPVZp,cplHpmcHpmVP,cplHpmcVWmVP,cplSdcSdVP,cplSucSuVP,OA2qSL(gt1,gt2)             & 
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvImSvReVP,     & 
& cplSvImSvReVZ,cplSvImSvReVZp,TSOddllSLLSM(gt1,gt2,gt3,gt4),TSOddllSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvImSvReVP,     & 
& cplSvImSvReVZ,cplSvImSvReVZp,TVOddllSLLSM(gt1,gt2,gt3,gt4),TVOddllSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvImSvReVP,     & 
& cplSvImSvReVZ,cplSvImSvReVZp,TSOddvvVRRSM(gt1,gt2,gt3,gt4),TSOddvvVLLSM(gt1,gt2,gt3,gt4)& 
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvImSvReVP,     & 
& cplSvImSvReVZ,cplSvImSvReVZp,TVOddvvVRRSM(gt1,gt2,gt3,gt4),TVOddvvVLLSM(gt1,gt2,gt3,gt4)& 
...
& cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,              & 
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,              & 
& cplSdcSdVZp,cplSucSuVG,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,TSO4dSLLSM(gt1,gt2,gt3,gt4)   & 
...
& cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,              & 
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,              & 
& cplSdcSdVZp,cplSucSuVG,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,TVO4dSLLSM(gt1,gt2,gt3,gt4)   & 
...
& cplGluFucSuR,cplhhcHpmVWm,cplhhcVWmVWm,cplhhHpmcHpm,cplhhHpmcVWm,cplHpmcHpmVZ,         & 
& cplHpmcHpmVZp,cplHpmcVWmVZ,cplHpmcVWmVZp,cplHpmSvImcSe,cplHpmSvRecSe,cplSdcHpmcSu,     & 
& cplSdcSucVWm,cplSvImcSeVWm,cplSvRecSeVWm,TSOdulvSLLSM(gt1,gt2,gt3,gt4),TSOdulvSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplGluFucSuR,cplhhcHpmVWm,cplhhcVWmVWm,cplhhHpmcHpm,cplhhHpmcVWm,cplHpmcHpmVZ,         & 
& cplHpmcHpmVZp,cplHpmcVWmVZ,cplHpmcVWmVZp,cplHpmSvImcSe,cplHpmSvRecSe,cplSdcHpmcSu,     & 
& cplSdcSucVWm,cplSvImcSeVWm,cplSvRecSeVWm,TVOdulvSLLSM(gt1,gt2,gt3,gt4),TVOdulvSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplSvImSvReVZp,BOddllSLLSM(gt1,gt2,gt3,gt4),BOddllSRRSM(gt1,gt2,gt3,gt4)               & 
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvImSvReVP,     & 
& cplSvImSvReVZ,cplSvImSvReVZp,PSOddllSLLSM(gt1,gt2,gt3,gt4),PSOddllSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvImSvReVP,     & 
& cplSvImSvReVZ,cplSvImSvReVZp,PVOddllSLLSM(gt1,gt2,gt3,gt4),PVOddllSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvImSvReVP,     & 
& cplSvImSvReVZ,cplSvImSvReVZp,BOddvvVRRSM(gt1,gt2,gt3,gt4),BOddvvVLLSM(gt1,gt2,gt3,gt4) & 
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvImSvReVP,     & 
& cplSvImSvReVZ,cplSvImSvReVZp,PSOddvvVRRSM(gt1,gt2,gt3,gt4),PSOddvvVLLSM(gt1,gt2,gt3,gt4)& 
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvImSvReVP,     & 
& cplSvImSvReVZ,cplSvImSvReVZp,PVOddvvVRRSM(gt1,gt2,gt3,gt4),PVOddvvVLLSM(gt1,gt2,gt3,gt4)& 
...
& cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,              & 
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,              & 
& cplSdcSdVZp,cplSucSuVG,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,BO4dSLLSM(gt1,gt2,gt3,gt4)    & 
...
& cplcFuFdcVWmR,cplcFuFuVPL,cplcFuFuVPR,cplChiChiVPL,cplChiChiVPR,cplChiFdcSdL,          & 
& cplChiFdcSdR,cplcHpmVPVWm,cplcVWmVPVWm,cplGluFdcSdL,cplGluFdcSdR,cplhhVPVZ,            & 
& cplhhVPVZp,cplHpmcHpmVP,cplHpmcVWmVP,cplSdcSdVP,cplSucSuVP,OA2qSLSM(gt1,gt2)           & 
...
If (MatchingOrder.gt.-1) Then 
Call RunSM_and_SUSY_RGEs(mz,g1input,g2input,g3input,gBLinput,gYBinput,gBYinput,       & 
...
& M2input,M3input,MBpinput,vdinput,vuinput,x1input,x2input,g1,g2,g3,gBL,gYB,             & 
& gBY,Yd,Ye,Yu,Yx,Yv,MuP,Mu,Td,Te,Tu,Tx,Tv,BMuP,Bmu,mq2,ml2,mHd2,mHu2,md2,               & 
& mu2,me2,mv2,mC12,mC22,MBBp,M1,M2,M3,MBp,vd,vu,x1,x2,CKM_MZ,sinW2_MZ,Alpha_MZ,          & 
& AlphaS_MZ,.true.)
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvImSvReVP,     & 
& cplSvImSvReVZ,cplSvImSvReVZp,TSOllddSLL(gt1,gt2,gt3,gt4),TSOllddSRR(gt1,gt2,gt3,gt4)   & 
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvImSvReVP,     & 
& cplSvImSvReVZ,cplSvImSvReVZp,TVOllddSLL(gt1,gt2,gt3,gt4),TVOllddSRR(gt1,gt2,gt3,gt4)   & 
...
& cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,cplSecSeVP,               & 
& cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvImSvReVP,cplSvImSvReVZ,  & 
& cplSvImSvReVZp,TSOlluuSLL(gt1,gt2,gt3,gt4),TSOlluuSRR(gt1,gt2,gt3,gt4),TSOlluuSRL(gt1,gt2,gt3,gt4)& 
...
& cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,cplSecSeVP,               & 
& cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvImSvReVP,cplSvImSvReVZ,  & 
& cplSvImSvReVZp,TVOlluuSLL(gt1,gt2,gt3,gt4),TVOlluuSRR(gt1,gt2,gt3,gt4),TVOlluuSRL(gt1,gt2,gt3,gt4)& 
...
& cplSvImSvReVP,cplSvImSvReVZ,cplSvImSvReVZp,TSO4lSLL(gt1,gt2,gt3,gt4),TSO4lSRR(gt1,gt2,gt3,gt4)& 
...
& cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,   & 
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,             & 
& cplSvImSvReVP,cplSvImSvReVZ,cplSvImSvReVZp,TVO4lSLL(gt1,gt2,gt3,gt4),TVO4lSRR(gt1,gt2,gt3,gt4)& 
...
& cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,   & 
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,             & 
& cplSvImSvReVP,cplSvImSvReVZ,cplSvImSvReVZp,TSO4lSLLcross(gt1,gt2,gt3,gt4)              & 
...
& cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,   & 
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,             & 
& cplSvImSvReVP,cplSvImSvReVZ,cplSvImSvReVZp,TVO4lSLLcross(gt1,gt2,gt3,gt4)              & 
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvImSvReVP,     & 
& cplSvImSvReVZ,cplSvImSvReVZp,BOllddSLL(gt1,gt2,gt3,gt4),BOllddSRR(gt1,gt2,gt3,gt4)     & 
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvImSvReVP,     & 
& cplSvImSvReVZ,cplSvImSvReVZp,PSOllddSLL(gt1,gt2,gt3,gt4),PSOllddSRR(gt1,gt2,gt3,gt4)   & 
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvImSvReVP,     & 
& cplSvImSvReVZ,cplSvImSvReVZp,PVOllddSLL(gt1,gt2,gt3,gt4),PVOllddSRR(gt1,gt2,gt3,gt4)   & 
...
& cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,cplSecSeVP,               & 
& cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvImSvReVP,cplSvImSvReVZ,  & 
& cplSvImSvReVZp,BOlluuSLL(gt1,gt2,gt3,gt4),BOlluuSRR(gt1,gt2,gt3,gt4),BOlluuSRL(gt1,gt2,gt3,gt4)& 
...
& cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,cplSecSeVP,               & 
& cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvImSvReVP,cplSvImSvReVZ,  & 
& cplSvImSvReVZp,PSOlluuSLL(gt1,gt2,gt3,gt4),PSOlluuSRR(gt1,gt2,gt3,gt4),PSOlluuSRL(gt1,gt2,gt3,gt4)& 
...
& cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,cplSecSeVP,               & 
& cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvImSvReVP,cplSvImSvReVZ,  & 
& cplSvImSvReVZp,PVOlluuSLL(gt1,gt2,gt3,gt4),PVOlluuSRR(gt1,gt2,gt3,gt4),PVOlluuSRL(gt1,gt2,gt3,gt4)& 
...
& cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,   & 
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,             & 
& cplSvImSvReVP,cplSvImSvReVZ,cplSvImSvReVZp,BO4lSLL(gt1,gt2,gt3,gt4),BO4lSRR(gt1,gt2,gt3,gt4)& 
...
& cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,   & 
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,             & 
& cplSvImSvReVP,cplSvImSvReVZ,cplSvImSvReVZp,PSO4lSLL(gt1,gt2,gt3,gt4),PSO4lSRR(gt1,gt2,gt3,gt4)& 
...
& cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,   & 
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,             & 
& cplSvImSvReVP,cplSvImSvReVZ,cplSvImSvReVZp,PVO4lSLL(gt1,gt2,gt3,gt4),PVO4lSRR(gt1,gt2,gt3,gt4)& 
...
& cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,   & 
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,             & 
& cplSvImSvReVP,cplSvImSvReVZ,cplSvImSvReVZp,BO4lSLLcross(gt1,gt2,gt3,gt4)               & 
...
& cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,   & 
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,             & 
& cplSvImSvReVP,cplSvImSvReVZ,cplSvImSvReVZp,PSO4lSLLcross(gt1,gt2,gt3,gt4)              & 
...
& cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,   & 
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,             & 
& cplSvImSvReVP,cplSvImSvReVZ,cplSvImSvReVZp,PVO4lSLLcross(gt1,gt2,gt3,gt4)              & 
...
& MSvRe2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhcVWmVWm,cplAhAhVZVZ,cplAhhhVZ,            & 
& cplAhHpmcVWm,cplcChaChaVZL,cplcChaChaVZR,cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVZL,          & 
& cplcFeFeVZR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuVZL,cplcFuFuVZR,cplcgAgWmcVWm,         & 
& cplcgWmgWmVZ,cplcgWpCgAcVWm,cplcgWpCgWpCVZ,cplcgWpCgZcVWm,cplcgWpCgZpcVWm,             & 
& cplcgZgWmcVWm,cplcgZpgWmcVWm,cplChiChacVWmL,cplChiChacVWmR,cplChiChiVZL,               & 
...
& cplSdcSdVZ,cplSdcSdVZVZ,cplSdcSucVWm,cplSecSecVWmVWm,cplSecSeVZ,cplSecSeVZVZ,          & 
& cplSeSvImcVWm,cplSeSvRecVWm,cplSucSucVWmVWm,cplSucSuVZ,cplSucSuVZVZ,cplSvImSvImcVWmVWm,& 
& cplSvImSvImVZVZ,cplSvImSvReVZ,cplSvReSvRecVWmVWm,cplSvReSvReVZVZ,dRho)
...
& MSe,MSe2,MSu,MSu2,MSvIm,MSvIm2,MSvRe,MSvRe2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,            & 
& cplAhhhVP,cplcChaChaVPL,cplcChaChaVPR,cplChiChiVPL,cplChiChiVPR,cplcFdFdVPL,           & 
& cplcFdFdVPR,cplcFeFeVPL,cplcFeFeVPR,cplcFuFuVPL,cplcFuFuVPR,cplFvFvVPL,cplFvFvVPR,     & 
& cplcgWmgWmVP,cplcgWpCgWpCVP,cplhhVPVZ,cplhhVPVZp,cplHpmcHpmVP,cplHpmcVWmVP,            & 
& cplSdcSdVP,cplSecSeVP,cplSucSuVP,cplSvImSvReVP,cplcVWmVPVWm,cplAhAhVPVP,               & 
& cplhhhhVPVP,cplHpmcHpmVPVP,cplSdcSdVPVP,cplSecSeVPVP,cplSucSuVPVP,cplSvImSvImVPVP,     & 
& cplSvReSvReVPVP,cplcVWmVPVPVWm1,cplcVWmVPVPVWm2,cplcVWmVPVPVWm3,cplAhhhVZ,             & 
...
& cplcVWmVWmVZVZ1,cplcVWmVWmVZVZ2,cplcVWmVWmVZVZ3,cplHpmcVWmVZp,cplcVWmVWmVZp,           & 
& cplcVWmVWmVZpVZp1,cplcVWmVWmVZpVZp2,cplcVWmVWmVZpVZp3,cplAhHpmcVWm,cplChiChacVWmL,     & 
& cplChiChacVWmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplFvFecVWmL,cplFvFecVWmR,cplcgWpCgAcVWm,   & 
& cplcgAgWmcVWm,cplcgZgWmcVWm,cplcgZpgWmcVWm,cplcgWpCgZcVWm,cplcgWpCgZpcVWm,             & 
& cplhhHpmcVWm,cplhhcVWmVWm,cplSdcSucVWm,cplSeSvImcVWm,cplSeSvRecVWm,cplAhAhcVWmVWm,     & 
& cplhhhhcVWmVWm,cplHpmcHpmcVWmVWm,cplSdcSdcVWmVWm,cplSecSecVWmVWm,cplSucSucVWmVWm,      & 
& cplSvImSvImcVWmVWm,cplSvReSvRecVWmVWm,cplcVWmcVWmVWmVWm1,cplcVWmcVWmVWmVWm2,           & 
& cplcVWmcVWmVWmVWm3,cplcHpmVWmVZ,cplcHpmVPVWm,cplAhAhVPVZ,cplhhhhVPVZ,cplHpmcHpmVPVZ,   & 
& cplSdcSdVPVZ,cplSecSeVPVZ,cplSucSuVPVZ,cplSvImSvImVPVZ,cplSvReSvReVPVZ,cplcVWmVPVWmVZ1,& 
& cplcVWmVPVWmVZ2,cplcVWmVPVWmVZ3,cplcHpmVWmVZp,cplAhAhVPVZp,cplhhhhVPVZp,               & 
& cplHpmcHpmVPVZp,cplSdcSdVPVZp,cplSecSeVPVZp,cplSucSuVPVZp,cplSvImSvImVPVZp,            & 
& cplSvReSvReVPVZp,cplcVWmVPVWmVZp1,cplcVWmVPVWmVZp2,cplcVWmVPVWmVZp3,cplAhAhVZVZp,      & 
& cplhhhhVZVZp,cplHpmcHpmVZVZp,cplSdcSdVZVZp,cplSecSeVZVZp,cplSucSuVZVZp,cplSvImSvImVZVZp,& 
& cplSvReSvReVZVZp,cplcVWmVWmVZVZp1,cplcVWmVWmVZVZp2,cplcVWmVWmVZVZp3,Spar,              & 
& Tpar,Upar)
...
gBLinput = Sqrt(3._dp/2._dp)*gBLinput 
End subroutine CalculateLowEnergyConstraints 
 
 
End Module LowEnergy_BLSSM 

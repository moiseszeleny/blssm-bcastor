...
& gSeAhChaFv,gSeAhChiFe,gSeChaChacSe,gSeSvImChaChi,gSeSvReChaChi,gSeChaFecHpm,           & 
& gSehhChaFv,gSeHpmChacFe,gSeSeChacCha,gSeSeChiChi,gSehhChiFe,gSeHpmChiFv,               & 
& gSeFeFdcSd,gSeFeFecSe,gSeFeFucSu,gSeSvImFeFv,gSeSvReFeFv,gSeHpmFecCha,gSeFeSdcFd,      & 
& gSeSeFecFe,gSeFeSucFu,gSeFvFdcSu,gSeSeFvFv,gSeFvSdcFu,gSeSeFdcFd,gSeSeFucFu,           & 
& gSeSvImFdcFu,gSeSvReFdcFu,epsI,deltaM,CheckRealStates,gT,gPartial,BR)
...
Complex(dp) :: cplAhSecSe(4,6,6),cplcChacFuSdL(2,3,6),cplcChacFuSdR(2,3,6),cplcChaChaAhL(2,2,4),     & 
...
Real(dp),Intent(inout) :: gSeAhChaFv(6,4,2,6),gSeAhChiFe(6,4,7,3),gSeChaChacSe(6,2,2,6),gSeSvImChaChi(6,6,2,7), & 
& gSeSvReChaChi(6,6,2,7),gSeChaFecHpm(6,2,3,2),gSehhChaFv(6,4,2,6),gSeHpmChacFe(6,2,2,3),& 
& gSeSeChacCha(6,6,2,2),gSeSeChiChi(6,6,7,7),gSehhChiFe(6,4,7,3),gSeHpmChiFv(6,2,7,6),   & 
...
Real(dp) :: gSeAhChaFvi(4,2,6),gSeAhChiFei(4,7,3),gSeChaChacSei(2,2,6),gSeSvImChaChii(6,2,7),     & 
& gSeSvReChaChii(6,2,7),gSeChaFecHpmi(2,3,2),gSehhChaFvi(4,2,6),gSeHpmChacFei(2,2,3),    & 
& gSeSeChacChai(6,2,2),gSeSeChiChii(6,7,7),gSehhChiFei(4,7,3),gSeHpmChiFvi(2,7,6),       & 
...
& M3,MBp,vd,vu,x1,x2,cplAhSecSe,cplcChacFuSdL,cplcChacFuSdR,cplcChaChaAhL,               & 
...
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFeChaSvImL,          & 
...
& cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZpL,cplcFuFuVZpR,cplcFuFuVZR,cplChiChacHpmL,          & 
...
& cplFvFvhhR,cplFvFvVZL,cplFvFvVZpL,cplFvFvVZpR,cplFvFvVZR,cplhhSecSe,cplHpmSvImcSe,     & 
& cplHpmSvRecSe,cplSecSeVZ,cplSecSeVZp,cplSvImcSeVWm,cplSvRecSeVWm,deltaM)
...
& cplSecSeVZ,cplSecSeVZp,cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,cplcChaChahhR,        & 
& cplcChaChaVZL,cplcChaChaVZR,cplcChaChaVZpL,cplcChaChaVZpR,cplcChaFvSeL,cplcChaFvSeR,   & 
& cplFvChacSeL,cplFvChacSeR,deltaM,epsI,check,gSeSeChacChai)
...
gSeSeFvFvi = 0._dp 
Call SeToSeFvFv(i_run,MSe,MFv,MVZ,MVZp,MAh,Mhh,MCha,cplAhSecSe,cplhhSecSe,            & 
& cplSecSeVZ,cplSecSeVZp,cplcChaFvSeL,cplcChaFvSeR,cplFvChacSeL,cplFvChacSeR,            & 
& cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVZL,cplFvFvVZR,cplFvFvVZpL,         & 
& cplFvFvVZpR,deltaM,epsI,check,gSeSeFvFvi)
...
Real(dp),Intent(in) :: MAh(4),MCha(2),MFv(6),MSe(6)

Complex(dp),Intent(in) :: cplAhSecSe(4,6,6),cplcChaChaAhL(2,2,4),cplcChaChaAhR(2,2,4),cplFvChacSeL(6,2,6),      & 
& cplFvChacSeR(6,2,6),cplFvFvAhL(6,6,4),cplFvFvAhR(6,6,4)
...
Real(dp),Intent(in) :: MAh(4),MChi(7),MFe(3),MSe(6)

Complex(dp),Intent(in) :: cplAhSecSe(4,6,6),cplcFeFeAhL(3,3,4),cplcFeFeAhR(3,3,4),cplChiChiAhL(7,7,4),          & 
& cplChiChiAhR(7,7,4),cplChiFecSeL(7,3,6),cplChiFecSeR(7,3,6)
...
Isum = 256 
Allocate( gSum(4,7,3, Isum) ) 
Allocate( Contribution(4,7,3, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
Real(dp),Intent(in) :: MSvIm(6),MCha(2),MChi(7),MVWm,MHpm(2),MFe(3),MFv(6),MSe(6)
...
Real(dp),Intent(in) :: MSvRe(6),MCha(2),MChi(7),MVWm,MHpm(2),MFe(3),MFv(6),MSe(6)
...
Real(dp),Intent(in) :: MCha(2),MFe(3),MHpm(2),MFv(6),MChi(7),MSe(6)

Complex(dp),Intent(in) :: cplChiChacHpmL(7,2,2),cplChiChacHpmR(7,2,2),cplChiFecSeL(7,3,6),cplChiFecSeR(7,3,6),  & 
...
Real(dp),Intent(in) :: Mhh(4),MCha(2),MFv(6),MSe(6)

Complex(dp),Intent(in) :: cplhhSecSe(4,6,6),cplcChaChahhL(2,2,4),cplcChaChahhR(2,2,4),cplFvChacSeL(6,2,6),      & 
& cplFvChacSeR(6,2,6),cplFvFvhhL(6,6,4),cplFvFvhhR(6,6,4)
...
Real(dp),Intent(in) :: MSe(6),MCha(2),MVZ,MVZp,MAh(4),Mhh(4),MFv(6)

Complex(dp),Intent(in) :: cplAhSecSe(4,6,6),cplhhSecSe(4,6,6),cplSecSeVZ(6,6),cplSecSeVZp(6,6),cplcChaChaAhL(2,2,4),& 
& cplcChaChaAhR(2,2,4),cplcChaChahhL(2,2,4),cplcChaChahhR(2,2,4),cplcChaChaVZL(2,2),     & 
& cplcChaChaVZR(2,2),cplcChaChaVZpL(2,2),cplcChaChaVZpR(2,2),cplcChaFvSeL(2,6,6),        & 
& cplcChaFvSeR(2,6,6),cplFvChacSeL(6,2,6),cplFvChacSeR(6,2,6)
...
Real(dp),Intent(in) :: MSe(6),MChi(7),MVZ,MVZp,MAh(4),Mhh(4),MFe(3)

Complex(dp),Intent(in) :: cplAhSecSe(4,6,6),cplhhSecSe(4,6,6),cplSecSeVZ(6,6),cplSecSeVZp(6,6),cplcFeChiSeL(3,7,6),& 
& cplcFeChiSeR(3,7,6),cplChiChiAhL(7,7,4),cplChiChiAhR(7,7,4),cplChiChihhL(7,7,4),       & 
& cplChiChihhR(7,7,4),cplChiChiVZL(7,7),cplChiChiVZR(7,7),cplChiChiVZpL(7,7),            & 
& cplChiChiVZpR(7,7),cplChiFecSeL(7,3,6),cplChiFecSeR(7,3,6)
...
Real(dp),Intent(in) :: Mhh(4),MChi(7),MFe(3),MSe(6)

Complex(dp),Intent(in) :: cplhhSecSe(4,6,6),cplcFeFehhL(3,3,4),cplcFeFehhR(3,3,4),cplChiChihhL(7,7,4),          & 
& cplChiChihhR(7,7,4),cplChiFecSeL(7,3,6),cplChiFecSeR(7,3,6)
...
Real(dp),Intent(in) :: MHpm(2),MChi(7),MFv(6),MSvIm(6),MSvRe(6),MFe(3),MCha(2),MSe(6)

Complex(dp),Intent(in) :: cplHpmSvImcSe(2,6,6),cplHpmSvRecSe(2,6,6),cplcChaChiHpmL(2,7,2),cplcChaChiHpmR(2,7,2),& 
& cplcFeFvHpmL(3,6,2),cplcFeFvHpmR(3,6,2),cplChiFecSeL(7,3,6),cplChiFecSeR(7,3,6),       & 
...
Isum = 289 
Allocate( gSum(2,7,6, Isum) ) 
Allocate( Contribution(2,7,6, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
Real(dp),Intent(in) :: MFe(3),MFd(3),MSd(6),MChi(7),MSe(6)

Complex(dp),Intent(in) :: cplChiFdcSdL(7,3,6),cplChiFdcSdR(7,3,6),cplChiFecSeL(7,3,6),cplChiFecSeR(7,3,6)
...
Real(dp),Intent(in) :: MFe(3),MSe(6),MChi(7)
...
Real(dp),Intent(in) :: MFe(3),MFu(3),MSu(6),MChi(7),MSe(6)

Complex(dp),Intent(in) :: cplChiFecSeL(7,3,6),cplChiFecSeR(7,3,6),cplChiFucSuL(7,3,6),cplChiFucSuR(7,3,6)
...
Real(dp),Intent(in) :: MSvIm(6),MFe(3),MFv(6),MVWm,MHpm(2),MCha(2),MChi(7),MSe(6)
...
Real(dp),Intent(in) :: MSvRe(6),MFe(3),MFv(6),MVWm,MHpm(2),MCha(2),MChi(7),MSe(6)
...
Real(dp),Intent(in) :: MHpm(2),MFe(3),MCha(2),MSvIm(6),MSvRe(6),MChi(7),MSe(6)

Complex(dp),Intent(in) :: cplHpmSvImcSe(2,6,6),cplHpmSvRecSe(2,6,6),cplcChaChiHpmL(2,7,2),cplcChaChiHpmR(2,7,2),& 
& cplcChaFeSvImL(2,3,6),cplcChaFeSvImR(2,3,6),cplcChaFeSvReL(2,3,6),cplcChaFeSvReR(2,3,6),& 
& cplChiFecSeL(7,3,6),cplChiFecSeR(7,3,6)
...
Real(dp),Intent(in) :: MFe(3),MSd(6),MFd(3),MChi(7),MSe(6)

Complex(dp),Intent(in) :: cplcFdChiSdL(3,7,6),cplcFdChiSdR(3,7,6),cplChiFecSeL(7,3,6),cplChiFecSeR(7,3,6)
...
Real(dp),Intent(in) :: MSe(6),MFe(3),MVZ,MVZp,MAh(4),Mhh(4),MChi(7)

Complex(dp),Intent(in) :: cplAhSecSe(4,6,6),cplhhSecSe(4,6,6),cplSecSeVZ(6,6),cplSecSeVZp(6,6),cplcFeChiSeL(3,7,6),& 
& cplcFeChiSeR(3,7,6),cplcFeFeAhL(3,3,4),cplcFeFeAhR(3,3,4),cplcFeFehhL(3,3,4),          & 
& cplcFeFehhR(3,3,4),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFeFeVZpL(3,3),cplcFeFeVZpR(3,3),& 
& cplChiFecSeL(7,3,6),cplChiFecSeR(7,3,6)
...
Real(dp),Intent(in) :: MFe(3),MSu(6),MFu(3),MChi(7),MSe(6)

Complex(dp),Intent(in) :: cplcFuChiSuL(3,7,6),cplcFuChiSuR(3,7,6),cplChiFecSeL(7,3,6),cplChiFecSeR(7,3,6)
...
Subroutine SeToSeFvFv(iIN,MSe,MFv,MVZ,MVZp,MAh,Mhh,MCha,cplAhSecSe,cplhhSecSe,        & 
& cplSecSeVZ,cplSecSeVZp,cplcChaFvSeL,cplcChaFvSeR,cplFvChacSeL,cplFvChacSeR,            & 
& cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVZL,cplFvFvVZR,cplFvFvVZpL,         & 
...
Real(dp),Intent(in) :: MSe(6),MFv(6),MVZ,MVZp,MAh(4),Mhh(4),MCha(2)

Complex(dp),Intent(in) :: cplAhSecSe(4,6,6),cplhhSecSe(4,6,6),cplSecSeVZ(6,6),cplSecSeVZp(6,6),cplcChaFvSeL(2,6,6),& 
& cplcChaFvSeR(2,6,6),cplFvChacSeL(6,2,6),cplFvChacSeR(6,2,6),cplFvFvAhL(6,6,4),         & 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Se->Se Fv Fv Propagator: VZp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Se->Se Fv Fv Propagator: VZ,VZp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Se->Se Fv Fv Propagator: VZp,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Se->Se Fv Fv Propagator: VZp,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "Se->Se Fv Fv Propagator: VZp,Cha" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Real(dp),Intent(in) :: MSe(6),MFd(3),MVZ,MVZp,MAh(4),Mhh(4)

Complex(dp),Intent(in) :: cplAhSecSe(4,6,6),cplhhSecSe(4,6,6),cplSecSeVZ(6,6),cplSecSeVZp(6,6),cplcFdFdAhL(3,3,4),& 
& cplcFdFdAhR(3,3,4),cplcFdFdhhL(3,3,4),cplcFdFdhhR(3,3,4),cplcFdFdVZL(3,3),             & 
...
Real(dp),Intent(in) :: MSe(6),MFu(3),MVZ,MVZp,MAh(4),Mhh(4)

Complex(dp),Intent(in) :: cplAhSecSe(4,6,6),cplhhSecSe(4,6,6),cplSecSeVZ(6,6),cplSecSeVZp(6,6),cplcFuFuAhL(3,3,4),& 

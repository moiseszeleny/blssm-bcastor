...
! ------------------------------------------------------------------------------  
! File created at 16:17 on 25.7.2023   
! ----------------------------------------------------------------------  
 
 
Module SvRe3Decays_BLSSM 
...
& gSvReSvReFdcFd,gSvReSvReFucFu,epsI,deltaM,CheckRealStates,gT,gPartial,BR)
...
Complex(dp) :: cplAhSvImSvRe(4,6,6),cplAhSvReSvRe(4,6,6),cplcChaChaAhL(2,2,4),cplcChaChaAhR(2,2,4),  & 
...
Real(dp),Intent(inout) :: gSvReAhChacFe(6,4,2,3),gSvReAhChiFv(6,4,7,6),gSvRecSeChaChi(6,6,2,7),gSvRecHpmChaFv(6,2,2,6),& 
& gSvRehhChacFe(6,4,2,3),gSvReSvImChacCha(6,6,2,2),gSvReSvReChacCha(6,6,2,2),            & 
& gSvReSvImChiChi(6,6,7,7),gSvReSvReChiChi(6,6,7,7),gSvRecHpmChiFe(6,2,7,3),             & 
& gSvRehhChiFv(6,4,7,6),gSvReFeFucSd(6,3,3,6),gSvRecSeFeFv(6,6,3,6),gSvReFeSucFd(6,3,6,3),& 
...
Real(dp) :: gSvReAhChacFei(4,2,3),gSvReAhChiFvi(4,7,6),gSvRecSeChaChii(6,2,7),gSvRecHpmChaFvi(2,2,6),& 
& gSvRehhChacFei(4,2,3),gSvReSvImChacChai(6,2,2),gSvReSvReChacChai(6,2,2),               & 
& gSvReSvImChiChii(6,7,7),gSvReSvReChiChii(6,7,7),gSvRecHpmChiFei(2,7,3),gSvRehhChiFvi(4,7,6),& 
...
& ZUL,ZUR,ZVI,ZVR,ZW,ZZ,betaH,g1,g2,g3,gBL,gYB,gBY,Yd,Ye,Yu,Yx,Yv,MuP,Mu,Td,             & 
& Te,Tu,Tx,Tv,BMuP,Bmu,mq2,ml2,mHd2,mHu2,md2,mu2,me2,mv2,mC12,mC22,MBBp,M1,              & 
& M2,M3,MBp,vd,vu,x1,x2,cplAhSvImSvRe,cplAhSvReSvRe,cplcChaChaAhL,cplcChaChaAhR,         & 
...
Call SvReToSvImChacCha(i_run,MSvIm,MCha,MVZ,MVZp,MAh,Mhh,MFe,MSvRe,cplAhSvImSvRe,     & 
& cplhhSvImSvRe,cplSvImSvReVZ,cplSvImSvReVZp,cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,  & 
...
& cplcFeChaSvImR,cplcFeChaSvReL,cplcFeChaSvReR,deltaM,epsI,check,gSvReSvImChacChai)
...
Call SvReToSvImChiChi(i_run,MSvIm,MChi,MVZ,MVZp,MAh,Mhh,MFv,MSvRe,cplAhSvImSvRe,      & 
& cplhhSvImSvRe,cplSvImSvReVZ,cplSvImSvReVZp,cplChiChiAhL,cplChiChiAhR,cplChiChihhL,     & 
& cplChiChihhR,cplChiChiVZL,cplChiChiVZR,cplChiChiVZpL,cplChiChiVZpR,cplChiFvSvImL,      & 
& cplChiFvSvImR,cplChiFvSvReL,cplChiFvSvReR,deltaM,epsI,check,gSvReSvImChiChii)
...
Call SvReToSvImFecFe(i_run,MSvIm,MFe,MVZ,MVZp,MAh,Mhh,MCha,MSvRe,cplAhSvImSvRe,       & 
& cplhhSvImSvRe,cplSvImSvReVZ,cplSvImSvReVZp,cplcChaFeSvImL,cplcChaFeSvImR,              & 
...
& cplcFeFeVZR,cplcFeFeVZpL,cplcFeFeVZpR,deltaM,epsI,check,gSvReSvImFecFei)
...
Call SvReToSvImFvFv(i_run,MSvIm,MFv,MVZ,MVZp,MAh,Mhh,MChi,MSvRe,cplAhSvImSvRe,        & 
& cplhhSvImSvRe,cplSvImSvReVZ,cplSvImSvReVZp,cplChiFvSvImL,cplChiFvSvImR,cplChiFvSvReL,  & 
& cplChiFvSvReR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVZL,cplFvFvVZR,       & 
& cplFvFvVZpL,cplFvFvVZpR,deltaM,epsI,check,gSvReSvImFvFvi)
...
Call SvReToSvImFdcFd(i_run,MSvIm,MFd,MVZ,MVZp,MAh,Mhh,MSvRe,cplAhSvImSvRe,            & 
& cplhhSvImSvRe,cplSvImSvReVZ,cplSvImSvReVZp,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,        & 
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFdVZpL,cplcFdFdVZpR,deltaM,epsI,             & 
& check,gSvReSvImFdcFdi)

gSvReSvImFdcFd(i_run,:,:,:) = gSvReSvImFdcFdi 
gT(i_run) = gT(i_run) + Sum(gSvReSvImFdcFdi) 
 
gSvReSvImFucFui = 0._dp 
Call SvReToSvImFucFu(i_run,MSvIm,MFu,MVZ,MVZp,MAh,Mhh,MSvRe,cplAhSvImSvRe,            & 
& cplhhSvImSvRe,cplSvImSvReVZ,cplSvImSvReVZp,cplcFuFuAhL,cplcFuFuAhR,cplcFuFuhhL,        & 
& cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplcFuFuVZpL,cplcFuFuVZpR,deltaM,epsI,             & 
& check,gSvReSvImFucFui)
...
Real(dp),Intent(in) :: MAh(4),MCha(2),MFe(3),MSvIm(6),MSvRe(6)

Complex(dp),Intent(in) :: cplAhSvImSvRe(4,6,6),cplAhSvReSvRe(4,6,6),cplcChaChaAhL(2,2,4),cplcChaChaAhR(2,2,4),  & 
& cplcFeChaSvImL(3,2,6),cplcFeChaSvImR(3,2,6),cplcFeChaSvReL(3,2,6),cplcFeChaSvReR(3,2,6),& 
& cplcFeFeAhL(3,3,4),cplcFeFeAhR(3,3,4)
...
Real(dp),Intent(in) :: MAh(4),MChi(7),MFv(6),MSvIm(6),MSvRe(6)

Complex(dp),Intent(in) :: cplAhSvImSvRe(4,6,6),cplAhSvReSvRe(4,6,6),cplChiChiAhL(7,7,4),cplChiChiAhR(7,7,4),    & 
& cplChiFvSvImL(7,6,6),cplChiFvSvImR(7,6,6),cplChiFvSvReL(7,6,6),cplChiFvSvReR(7,6,6),   & 
& cplFvFvAhL(6,6,4),cplFvFvAhR(6,6,4)
...
Isum = 625 
Allocate( gSum(4,7,6, Isum) ) 
Allocate( Contribution(4,7,6, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
Real(dp),Intent(in) :: MSe(6),MCha(2),MChi(7),MVWm,MHpm(2),MFe(3),MFv(6),MSvRe(6)
...
Isum = 144 
Allocate( gSum(6,2,7, Isum) ) 
Allocate( Contribution(6,2,7, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
Real(dp),Intent(in) :: MHpm(2),MCha(2),MFv(6),MSe(6),MFe(3),MChi(7),MSvRe(6)

Complex(dp),Intent(in) :: cplSeSvRecHpm(6,6,2),cplcFeChaSvReL(3,2,6),cplcFeChaSvReR(3,2,6),cplChiChacHpmL(7,2,2),& 
& cplChiChacHpmR(7,2,2),cplChiFvSvReL(7,6,6),cplChiFvSvReR(7,6,6),cplFvChacSeL(6,2,6),   & 
...
Real(dp),Intent(in) :: Mhh(4),MCha(2),MFe(3),MSvIm(6),MSvRe(6)

Complex(dp),Intent(in) :: cplhhSvImSvRe(4,6,6),cplhhSvReSvRe(4,6,6),cplcChaChahhL(2,2,4),cplcChaChahhR(2,2,4),  & 
& cplcFeChaSvImL(3,2,6),cplcFeChaSvImR(3,2,6),cplcFeChaSvReL(3,2,6),cplcFeChaSvReR(3,2,6),& 
& cplcFeFehhL(3,3,4),cplcFeFehhR(3,3,4)
...
Subroutine SvReToSvImChacCha(iIN,MSvIm,MCha,MVZ,MVZp,MAh,Mhh,MFe,MSvRe,               & 
& cplAhSvImSvRe,cplhhSvImSvRe,cplSvImSvReVZ,cplSvImSvReVZp,cplcChaChaAhL,cplcChaChaAhR,  & 
& cplcChaChahhL,cplcChaChahhR,cplcChaChaVZL,cplcChaChaVZR,cplcChaChaVZpL,cplcChaChaVZpR, & 
& cplcChaFeSvImL,cplcChaFeSvImR,cplcChaFeSvReL,cplcChaFeSvReR,cplcFeChaSvImL,            & 
& cplcFeChaSvImR,cplcFeChaSvReL,cplcFeChaSvReR,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MSvIm(6),MCha(2),MVZ,MVZp,MAh(4),Mhh(4),MFe(3),MSvRe(6)

Complex(dp),Intent(in) :: cplAhSvImSvRe(4,6,6),cplhhSvImSvRe(4,6,6),cplSvImSvReVZ(6,6),cplSvImSvReVZp(6,6),     & 
...
mass(2) = MVZp 
m_in = MSvRe(iIN) 
coup(1) = Conjg(cplSvImSvReVZp(gt1,iIN)) 
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Cha cCha Propagator: VZp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Cha cCha Propagator: VZ,VZp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Cha cCha Propagator: VZp,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Cha cCha Propagator: VZp,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Cha cCha Propagator: VZp,bar[Fe]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Cha cCha Propagator: VZp,Fe" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Real(dp),Intent(in) :: MSvRe(6),MCha(2),MAh(4),Mhh(4),MFe(3)

Complex(dp),Intent(in) :: cplAhSvReSvRe(4,6,6),cplhhSvReSvRe(4,6,6),cplcChaChaAhL(2,2,4),cplcChaChaAhR(2,2,4),  & 
& cplcChaChahhL(2,2,4),cplcChaChahhR(2,2,4),cplcChaFeSvReL(2,3,6),cplcChaFeSvReR(2,3,6), & 
...
Subroutine SvReToSvImChiChi(iIN,MSvIm,MChi,MVZ,MVZp,MAh,Mhh,MFv,MSvRe,cplAhSvImSvRe,  & 
& cplhhSvImSvRe,cplSvImSvReVZ,cplSvImSvReVZp,cplChiChiAhL,cplChiChiAhR,cplChiChihhL,     & 
& cplChiChihhR,cplChiChiVZL,cplChiChiVZR,cplChiChiVZpL,cplChiChiVZpR,cplChiFvSvImL,      & 
& cplChiFvSvImR,cplChiFvSvReL,cplChiFvSvReR,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MSvIm(6),MChi(7),MVZ,MVZp,MAh(4),Mhh(4),MFv(6),MSvRe(6)
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Chi Chi Propagator: VZp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Chi Chi Propagator: VZ,VZp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Chi Chi Propagator: VZp,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Chi Chi Propagator: VZp,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Chi Chi Propagator: VZp,Fv" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Real(dp),Intent(in) :: MSvRe(6),MChi(7),MAh(4),Mhh(4),MFv(6)

Complex(dp),Intent(in) :: cplAhSvReSvRe(4,6,6),cplhhSvReSvRe(4,6,6),cplChiChiAhL(7,7,4),cplChiChiAhR(7,7,4),    & 
& cplChiChihhL(7,7,4),cplChiChihhR(7,7,4),cplChiFvSvReL(7,6,6),cplChiFvSvReR(7,6,6)
...
Real(dp),Intent(in) :: MHpm(2),MChi(7),MFe(3),MSe(6),MCha(2),MFv(6),MSvRe(6)

Complex(dp),Intent(in) :: cplSeSvRecHpm(6,6,2),cplcChaFeSvReL(2,3,6),cplcChaFeSvReR(2,3,6),cplChiChacHpmL(7,2,2),& 
& cplChiChacHpmR(7,2,2),cplChiFecSeL(7,3,6),cplChiFecSeR(7,3,6),cplChiFvSvReL(7,6,6),    & 
& cplChiFvSvReR(7,6,6),cplFvFecHpmL(6,3,2),cplFvFecHpmR(6,3,2)
...
Isum = 196 
Allocate( gSum(2,7,3, Isum) ) 
Allocate( Contribution(2,7,3, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
Real(dp),Intent(in) :: Mhh(4),MChi(7),MFv(6),MSvIm(6),MSvRe(6)

Complex(dp),Intent(in) :: cplhhSvImSvRe(4,6,6),cplhhSvReSvRe(4,6,6),cplChiChihhL(7,7,4),cplChiChihhR(7,7,4),    & 
& cplChiFvSvImL(7,6,6),cplChiFvSvImR(7,6,6),cplChiFvSvReL(7,6,6),cplChiFvSvReR(7,6,6),   & 
& cplFvFvhhL(6,6,4),cplFvFvhhR(6,6,4)
...
Real(dp),Intent(in) :: MSe(6),MFe(3),MFv(6),MVWm,MHpm(2),MCha(2),MChi(7),MSvRe(6)
...
Subroutine SvReToSvImFecFe(iIN,MSvIm,MFe,MVZ,MVZp,MAh,Mhh,MCha,MSvRe,cplAhSvImSvRe,   & 
& cplhhSvImSvRe,cplSvImSvReVZ,cplSvImSvReVZp,cplcChaFeSvImL,cplcChaFeSvImR,              & 
& cplcChaFeSvReL,cplcChaFeSvReR,cplcFeChaSvImL,cplcFeChaSvImR,cplcFeChaSvReL,            & 
& cplcFeChaSvReR,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,            & 
...
Real(dp),Intent(in) :: MSvIm(6),MFe(3),MVZ,MVZp,MAh(4),Mhh(4),MCha(2),MSvRe(6)
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Fe cFe Propagator: VZp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Fe cFe Propagator: VZ,VZp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Fe cFe Propagator: VZp,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Fe cFe Propagator: VZp,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Fe cFe Propagator: VZp,bar[Cha]" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Fe cFe Propagator: VZp,Cha" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Real(dp),Intent(in) :: MSvRe(6),MFe(3),MAh(4),Mhh(4),MCha(2)

Complex(dp),Intent(in) :: cplAhSvReSvRe(4,6,6),cplhhSvReSvRe(4,6,6),cplcChaFeSvReL(2,3,6),cplcChaFeSvReR(2,3,6),& 
& cplcFeChaSvReL(3,2,6),cplcFeChaSvReR(3,2,6),cplcFeFeAhL(3,3,4),cplcFeFeAhR(3,3,4),     & 
& cplcFeFehhL(3,3,4),cplcFeFehhR(3,3,4)
...
Real(dp),Intent(in) :: MFv(6),MFd(3),MSd(6),MChi(7),MSvRe(6)

Complex(dp),Intent(in) :: cplChiFdcSdL(7,3,6),cplChiFdcSdR(7,3,6),cplChiFvSvReL(7,6,6),cplChiFvSvReR(7,6,6)
...
Real(dp),Intent(in) :: MFv(6),MFu(3),MSu(6),MChi(7),MSvRe(6)

Complex(dp),Intent(in) :: cplChiFucSuL(7,3,6),cplChiFucSuR(7,3,6),cplChiFvSvReL(7,6,6),cplChiFvSvReR(7,6,6)
...
Subroutine SvReToSvImFvFv(iIN,MSvIm,MFv,MVZ,MVZp,MAh,Mhh,MChi,MSvRe,cplAhSvImSvRe,    & 
& cplhhSvImSvRe,cplSvImSvReVZ,cplSvImSvReVZp,cplChiFvSvImL,cplChiFvSvImR,cplChiFvSvReL,  & 
& cplChiFvSvReR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVZL,cplFvFvVZR,       & 
& cplFvFvVZpL,cplFvFvVZpR,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MSvIm(6),MFv(6),MVZ,MVZp,MAh(4),Mhh(4),MChi(7),MSvRe(6)
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Fv Fv Propagator: VZp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Fv Fv Propagator: VZ,VZp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Fv Fv Propagator: VZp,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Fv Fv Propagator: VZp,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Fv Fv Propagator: VZp,Chi" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Real(dp),Intent(in) :: MSvRe(6),MFv(6),MAh(4),Mhh(4),MChi(7)

Complex(dp),Intent(in) :: cplAhSvReSvRe(4,6,6),cplhhSvReSvRe(4,6,6),cplChiFvSvReL(7,6,6),cplChiFvSvReR(7,6,6),  & 
& cplFvFvAhL(6,6,4),cplFvFvAhR(6,6,4),cplFvFvhhL(6,6,4),cplFvFvhhR(6,6,4)
...
Subroutine SvReToSvImFdcFd(iIN,MSvIm,MFd,MVZ,MVZp,MAh,Mhh,MSvRe,cplAhSvImSvRe,        & 
& cplhhSvImSvRe,cplSvImSvReVZ,cplSvImSvReVZp,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,        & 
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFdVZpL,cplcFdFdVZpR,deltaM,epsI,             & 
...
Real(dp),Intent(in) :: MSvIm(6),MFd(3),MVZ,MVZp,MAh(4),Mhh(4),MSvRe(6)
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Fd cFd Propagator: VZp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Fd cFd Propagator: VZ,VZp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Fd cFd Propagator: VZp,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Fd cFd Propagator: VZp,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Subroutine SvReToSvImFucFu(iIN,MSvIm,MFu,MVZ,MVZp,MAh,Mhh,MSvRe,cplAhSvImSvRe,        & 
& cplhhSvImSvRe,cplSvImSvReVZ,cplSvImSvReVZp,cplcFuFuAhL,cplcFuFuAhR,cplcFuFuhhL,        & 
& cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplcFuFuVZpL,cplcFuFuVZpR,deltaM,epsI,             & 
& check,g,WriteContributions)
...
Real(dp),Intent(in) :: MSvIm(6),MFu(3),MVZ,MVZp,MAh(4),Mhh(4),MSvRe(6)
...
If (resD.ne.resD) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Fu cFu Propagator: VZp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Fu cFu Propagator: VZ,VZp" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Fu cFu Propagator: VZp,Ah" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
If (resS.ne.resS) Then 
Write(*,*) "NaN appearing in the following diagrams: " 
Write(*,*) "SvRe->SvIm Fu cFu Propagator: VZp,hh" 
Write(*,*)  "M_in: ",m_in 
Write(*,*)  "mass: ",mass 
Write(*,*)  "coup: ",coup 
gSum(gt1,gt2,gt3,Isum)= 0._dp  
...
Real(dp),Intent(in) :: MSvRe(6),MFd(3),MAh(4),Mhh(4)

Complex(dp),Intent(in) :: cplAhSvReSvRe(4,6,6),cplhhSvReSvRe(4,6,6),cplcFdFdAhL(3,3,4),cplcFdFdAhR(3,3,4),      & 
& cplcFdFdhhL(3,3,4),cplcFdFdhhR(3,3,4)
...
Real(dp),Intent(in) :: MSvRe(6),MFu(3),MAh(4),Mhh(4)

Complex(dp),Intent(in) :: cplAhSvReSvRe(4,6,6),cplhhSvReSvRe(4,6,6),cplcFuFuAhL(3,3,4),cplcFuFuAhR(3,3,4),      & 
& cplcFuFuhhL(3,3,4),cplcFuFuhhR(3,3,4)
